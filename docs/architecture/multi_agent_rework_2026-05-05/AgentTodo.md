...
4. **Read-only Agent Control GUI fourth**: next complete MAG-018 on top of backend view models. The GUI must not stitch raw tables in JavaScript and must not add trading controls.
