...
| `CCAgentWorkSpace/PM/workspace/reports/2026-05-15--post_rebuild_sync_7b33ab2e.md` | Post-rebuild sync：Mac/origin/Linux at `7b33ab2e`，engine/API rebuilt，`[27]` immediate PASS under fresh-restart grace，post-grace pending |
