...
| `2026-05-06--ref21_full_chain_replay_engine_dev_plan_v1_1.md` | REF-21 Full-Chain Replay Engine V1.1：8-agent audit 後的 active plan；將 12 條 blocker 轉為 dedicated subprocess、forbidden guard、edge snapshot、OOS、tier promotion、auth/rate、Bybit data reality、GUI safety 等硬門 |
