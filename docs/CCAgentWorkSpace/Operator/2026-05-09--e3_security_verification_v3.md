...
3. **Credential 處理**:
   ...
   - line 48-49: `export PG_PASSWORD="$PG_PASS"` + `export OPENCLAW_DATABASE_URL="postgresql://${PG_USER}:${PG_PASS}@..."` — **export 進子進程 env，但只在子進程的 ml_training_maintenance.py 子進程內可見**
