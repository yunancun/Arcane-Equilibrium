...
當前 14/14 prerequisites blocking：11 個固定 Linux trust/attestor paths absent，三個 external
...
reviewed checkpoint=`e68966670`，packet=`sha256:c13142b4…d5809`。GitHub Codex 累計
3 P1＋3 P2 已修；最後一項 P1 已把 caller-authored signer 改為 zero-input root-owned
`attest-v2` capability，自 immutable source view 生成完整 SSHSIG artifact。前一 checkpoint 的
launch/receipt `200 passed, 3 skipped`、recovery/kernel `904 passed, 9 skipped`，final
provider-class delta `90 passed`；attestor-owned adjacent set `416 passed, 9 skipped`。
