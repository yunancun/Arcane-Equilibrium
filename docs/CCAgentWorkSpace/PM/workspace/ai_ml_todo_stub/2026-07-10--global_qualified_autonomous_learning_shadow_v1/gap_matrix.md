...
| G2 Candidate selection | `PARTIAL_SOURCE_ACCEPTED` | WP2-A checkpoint `c84e14f5d` implements typed full identity, regime-specific evaluation, distinct-entry/day/quality/proof-gap/EVI/cost/cooldown/portfolio selection, durable no-candidate, and a true source review-to-repository chain; integrated `458`, cron-static `17`, all source gates zero findings. Runtime still has only historical `scanner_novelty`, side `NONE`, and no event-time candidate lineage. | Immutable prospective `candidate_event_context_v1`, evaluation-time context, event-driven primary handoff, deployment, and natural-cycle runtime proof. | P0; blocks terminal | WP2-B Module extraction and prospective lineage via PA/E1/E2/QC/MIT/AI-E/E4/QA; runtime later requires E3/BB. |
