...
ssh trade-core "cd ~/BybitOpenClaw/srv && source \$HOME/.venv/bin/activate && pg_pass=\$(grep POSTGRES_PASSWORD settings/environment_files/basic_system_services.env | cut -d= -f2-) && OPENCLAW_DATABASE_URL=\"postgresql://trading_admin:\${pg_pass}@127.0.0.1:5432/trading_ai\" OPENCLAW_BASE_DIR=\$HOME/BybitOpenClaw/srv python3 helper_scripts/db/passive_wait_healthcheck.py"
```
