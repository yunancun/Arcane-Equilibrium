...
> **NOTE 2026-05-28**：本 audit 引用的 `2026-05-02--ref20_paper_replay_lab_dev_plan_v2_1_round3.md` 已歸檔至 `docs/archive/2026-05-28--ref20_paper_replay_lab_dev_plan_superseded/`，由 v3 取代。Audit 內文未動，僅補本指標供後續追溯。
