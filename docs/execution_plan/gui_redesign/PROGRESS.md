...
## 狀態欄
- **STATUS**: IN_PROGRESS
- **CURRENT**: P0.4 C6d-4(漸層塌平 + killswitch #8b1a1a→--neg;機械無歧義,PA 排序先做;risk-tab.js 交易 E2 親算;了結 C6b canon-9 第四紅 pointer)
- **LAST-COMMIT**: 493864cb3(PA C6d micro-spec §13——三族細化+子批拆分+operator gate)
