...
/* ── §A 批次 7b 追加(2026-07-10 P0.2 batch 7b:governance;§11 append-only)── */
.fw-normal{ font-weight:var(--weight-regular)!important; }  /* 家族 3 字重:400 正常(bold 容器內文字回落正常字重的合法覆蓋) */
.px-4{ padding-left:var(--sp-4)!important; padding-right:var(--sp-4)!important; }  /* 家族 8 padding:sp-4 檔位(16px;按鈕 16-20px 水平內距歸宿) */
```
