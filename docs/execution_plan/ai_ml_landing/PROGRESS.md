...
**Ledger version**: 24
**Updated**: 2026-08-02（G0/LW1 final provider-class delta closure 與 external blocker 校準）
...
`S2E-LW1` has a clean source implementation checkpoint at `4c6e1962a`
