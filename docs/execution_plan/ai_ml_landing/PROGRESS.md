...
**Ledger version**: 25
**Updated**: 2026-08-02（Tier 1 durability anchor 取代 external WORM custody；operator packet rebind 與投影校正）
...
`S2E-LW1` has a clean source implementation checkpoint at `0253814b0`
(Tier 1 durability anchor; branch-local, not merged), but is
