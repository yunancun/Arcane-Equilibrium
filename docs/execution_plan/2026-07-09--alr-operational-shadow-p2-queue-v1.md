...
| P2-6 | ACTIVE | PM -> PA -> E1 -> E2 -> E4 -> QA -> PM; E3 -> BB -> PM before sweep | Reference graph -> quarantine -> grace/recheck -> sweep deletes only ALR-owned rebuildable unreferenced derived cache. |
