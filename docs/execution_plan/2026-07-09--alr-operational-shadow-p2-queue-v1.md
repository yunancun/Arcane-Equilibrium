...
| P2-5 | ACTIVE | PM -> QC -> MIT -> E1 -> E2 -> E4 -> QA -> PM | ProofPacket/RewardLedger feedback records gaps, rotates on `DEFER_EVIDENCE`, and never treats missing evidence as proof. |
