...
| P2-7 | ACTIVE | PM -> PA -> E1 -> E2 -> E4 -> QA -> PM | Health/state/metrics expose watermark, backlog, target, runs, evidence gaps, failures, restart recovery, retention bytes, and all authority counters. |
