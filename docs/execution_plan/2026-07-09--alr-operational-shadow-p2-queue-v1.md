...
| P2-3 | ACTIVE_IMPLEMENTATION_GATED | PM -> E3 -> BB -> PM -> PA -> E1 -> E2 -> E4 -> QA -> PM | Fresh gate permits source/isolated-test work only: best-effort post-persist source-identity notification, bounded listener/unit source, and least-privilege role contract. Role/secret provision, engine restart, and service start require post-implementation E2/E4/QA and a fresh exact prestart E3/BB recheck. |
