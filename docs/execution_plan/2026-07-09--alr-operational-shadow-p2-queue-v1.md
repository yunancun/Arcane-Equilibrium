...
| P2-3 | READY_FOR_PRESTART_E3_BB | PM -> E3 -> BB -> PM -> PA -> E1 -> E2 -> E4 -> QA -> PM | E2 re-review, E4, and QA passed after removal of unneeded `FOR SHARE`. The disposable listener proved actual LISTEN wake, one append-only chain, replay suppression, competing lock denial, and denied UPDATE/DELETE. A fresh exact prestart E3/BB recheck is now required before any role/secret, engine restart, or service start. |
