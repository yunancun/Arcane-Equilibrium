...
| `CCAgentWorkSpace/PM/workspace/reports/2026-08-02--s2e_lw1_external_prerequisite_action_packet.json` | Closed `s2e_lw1_operator_action_packet_v1`；綁 reviewed implementation checkpoint `d3a21f4e4`，列出 14 blockers、6-step action sequence 與不可升格的 closure/authority/runtime 邊界。 |
...
| `execution_plan/ai_ml_landing/PROGRESS.md` | Repo-resident AI/ML Session projection ledger；v20 起世代切檔：active tail 只保留當前 Sprint rows 與機器鎖定節（W5-RECEIPT-BINDING marker／obligations 表／adjudication block／effect DAG）；immutable attempt/closure record 才是 authoritative outcome。 |
...
| `execution_plan/ai_ml_landing/design/S2E-LW1-tier1-remediation.md` | S2E-LW1 Tier 1 durability anchor 三路對抗複核 FAIL 後的 remediation 設計正本（committed anchor floor／replica 雙簽章／host fingerprint／const:true 處置）。 |
...
| `CCAgentWorkSpace/PM/workspace/reports/2026-07-11--global_qualified_autonomous_learning_shadow_v1_wp3_read_only_repository_adapter_checkpoint.md` | WP3 repository checkpoint `c2bdefbf`: bounded immutable projection/lineage/bridge reconstruction, internal binding, one-snapshot race recheck, exact source bytes plus canonical adapter inputs, explicit schema-required overflow, and zero-write in-memory receipts. |
| `CCAgentWorkSpace/Operator/2026-07-11--global_qualified_autonomous_learning_shadow_v1_wp3_read_only_repository_adapter_checkpoint.md` | Operator mirror of the read-only WP3 acceptance, frozen V152/V153 boundary, zero runtime/authority effect, and WP4 collision-scan next action. |
| `CCAgentWorkSpace/PM/workspace/reports/2026-07-11--global_qualified_autonomous_learning_shadow_v1_wp4_schema_required_training_contract_checkpoint.md` | WP4 source checkpoint `f36379b9`: collision-free provisional V158 observation plus exact repository-receipt/PIT/reward/data/split/code/config/resource binding; always SCHEMA_REQUIRED and non-executable pending durable schema and isolated trainer/registry. |
| `CCAgentWorkSpace/Operator/2026-07-11--global_qualified_autonomous_learning_shadow_v1_wp4_schema_required_training_contract_checkpoint.md` | Operator mirror of the WP4 source-contract acceptance, zero fit/registry/runtime authority, provisional-unreserved V158 boundary, verification, and next E3/BB gate. |
| `CCAgentWorkSpace/PM/workspace/reports/2026-07-11--global_qualified_autonomous_learning_shadow_v1_wp4_v158_source_checkpoint.md` | WP4 V158 source checkpoint `beeb77325`: four-table isolated qualified-challenger persistence DDL, fixed APIs, exact ACL/replay/deferred-completeness/immutability contracts, inert disposable probes, source verification, and explicit unapplied/no-PG posture. |
| `CCAgentWorkSpace/Operator/2026-07-11--global_qualified_autonomous_learning_shadow_v1_wp4_v158_source_checkpoint.md` | Operator mirror of V158 source publication, unexecuted probes, zero PG/runtime/fit/artifact/registry/authority effect, persistent G3/G4 failure, and next repository-only durable-receipt tracer scope. |
| `CCAgentWorkSpace/PM/workspace/reports/2026-07-11--global_qualified_autonomous_learning_shadow_v1_wp4_qualified_receipt_repository_tracer_checkpoint.md` | WP4 fixed-writer repository tracer `c0aec681`: exact 30-field/hash/16-argument mapping, clean transaction ownership, complete PERSISTED/DUPLICATE validation, fake-DB verification, and explicit zero-PG/runtime effect. |
| `CCAgentWorkSpace/Operator/2026-07-11--global_qualified_autonomous_learning_shadow_v1_wp4_qualified_receipt_repository_tracer_checkpoint.md` | Operator mirror of repository-writer source acceptance, zero durable/runtime authority, and next fixed receipt-reader `FOUND/NOT_FOUND` TDD scope. |
| `CCAgentWorkSpace/PM/workspace/reports/2026-07-11--global_qualified_autonomous_learning_shadow_v1_wp4_qualified_receipt_reader_checkpoint.md` | WP4 contract-bound fixed reader `fb842a36`: internally derived two-key lookup, exact FOUND/NOT_FOUND and 20-field parity, clean transaction ownership, RED-to-GREEN and governed E2/E4/MIT evidence, and explicit zero-PG/runtime effect. |
| `CCAgentWorkSpace/Operator/2026-07-11--global_qualified_autonomous_learning_shadow_v1_wp4_qualified_receipt_reader_checkpoint.md` | Operator mirror of qualified-receipt reader source acceptance, zero durable/runtime authority, and next pure qualified training-result contract scope. |
| `CCAgentWorkSpace/PM/workspace/reports/2026-07-11--global_qualified_autonomous_learning_shadow_v1_wp4_qualified_training_result_observation_contract_checkpoint.md` | WP4 pure result-observation contract `c64c5e28`: exact FOUND admission, closed trainer/seed/timestamp/q10-q50-q90/metrics/resource binding, internally derived result identities, explicit NOT_ESTABLISHED/UNVERIFIED claims, bounded total validation, governed verification, and zero PG/runtime effect. |
| `CCAgentWorkSpace/Operator/2026-07-11--global_qualified_autonomous_learning_shadow_v1_wp4_qualified_training_result_observation_contract_checkpoint.md` | Operator mirror of result-observation contract source acceptance, zero fit/persistence/runtime authority, and next trusted fit-capture attestation contract design/TDD scope. |
| `CCAgentWorkSpace/PM/workspace/reports/2026-07-12--global_qualified_autonomous_learning_shadow_v1_wp4_trusted_fit_capture_attestation_contract_checkpoint.md` | WP4 pure fit-capture candidate `a09c70f2`: bounded raw actual-input/runner/q10-q50-q90 readback rehashing, immutable callback request, literal-True ephemeral externally-unchecked verdict, current-head governed verification, explicit NOT_ESTABLISHED/non-persistent/no-authority posture, and next durable-attestation schema pre-authoring gate. |
| `CCAgentWorkSpace/Operator/2026-07-12--global_qualified_autonomous_learning_shadow_v1_wp4_trusted_fit_capture_attestation_contract_checkpoint.md` | Operator mirror of fit-capture candidate source acceptance, zero fit/model/PG/runtime/authority effect, persistent G3/G4 failure, fresh V159-absent scan, and next durable-attestation schema design-only scope. |
| `CCAgentWorkSpace/PM/workspace/reports/2026-07-12--global_qualified_autonomous_learning_shadow_v1_wp4_durable_fit_attestation_schema_preauthoring_gate.md` | WP4 durable fit-attestation forward-schema design and source-authoring-only gate: exact signed receipt bytes, structural/durable identity separation, atomic complete binding, v1 hard closure, E3/BB approval, current-head confirmation, zero runtime/PG/fit/authority effect, and next source TDD. |
| `CCAgentWorkSpace/Operator/2026-07-12--global_qualified_autonomous_learning_shadow_v1_wp4_durable_fit_attestation_schema_preauthoring_gate.md` | Operator mirror of the durable schema preauthoring gate, V159 absent/unreserved, G3/G4 still failed, and the source/tests-only next boundary. |
| `CCAgentWorkSpace/PM/workspace/reports/2026-07-12--global_qualified_autonomous_learning_shadow_v1_wp4_durable_fit_attestation_schema_source_checkpoint.md` | WP4 forward V159 source checkpoint `27bfe34b`: exact authenticated receipt and durable-binding schema, six-file hashes, source/combined/Rust verification, zero-PG/runtime/fit boundary, public crates.io fetch incident, offline-reproducibility concern, and next disposable-PG gate. |
| `CCAgentWorkSpace/Operator/2026-07-12--global_qualified_autonomous_learning_shadow_v1_wp4_durable_fit_attestation_schema_source_checkpoint.md` | Operator mirror of V159 source acceptance, explicit public dependency-network delta, persistent G3/G4 failure, and governed isolated PG16/Timescale next scope. |
| `CCAgentWorkSpace/PM/workspace/reports/2026-07-12--global_qualified_autonomous_learning_shadow_v1_wp4_durable_fit_attestation_disposable_pg_verification_gate.md` | WP4 exact-head disposable PG16/Timescale verification: hosted run/job, functional/concurrency PASS, transient fixture counts, force-drop zero-survivor cleanup, 11-retry RCA, unchanged production/runtime/no-authority boundary, G1-G9 adjudication, and next handshake design gate. |
| `CCAgentWorkSpace/Operator/2026-07-12--global_qualified_autonomous_learning_shadow_v1_wp4_durable_fit_attestation_disposable_pg_verification_gate.md` | Operator mirror of `DONE_DISPOSABLE_PG_VERIFIED`: synthetic isolated behavior proven, production/runtime apply and real fit still absent, G3/G4 failed, Goal/WP4 active, next scope design-only. |
| `CCAgentWorkSpace/PM/workspace/reports/2026-07-12--global_qualified_autonomous_learning_shadow_v1_wp4_trusted_issuer_isolated_runner_handshake_design_preauthoring_gate.md` | WP4 pure handshake design gate: issuer-signed pre-fit request, nonce/admission/generation identity, trusted terminal receipt, three signature preimages, policy plus current revocation, closed outcome/replay semantics, pure AUTHENTICATED_UNCONSUMED ceiling, current V159 trust/atomicity limits, future fixed V160 coordinator, and zero execution effect. |
| `CCAgentWorkSpace/Operator/2026-07-12--global_qualified_autonomous_learning_shadow_v1_wp4_trusted_issuer_isolated_runner_handshake_design_preauthoring_gate.md` | Operator mirror of the handshake design acceptance, persistent G3/G4 failure, no bytes/source/PG/network/fit/model/authority effect, and the pure contract/source-test-only next gate. |
| `CCAgentWorkSpace/PM/workspace/reports/2026-07-12--global_qualified_autonomous_learning_shadow_v1_wp4_trusted_issuer_isolated_runner_handshake_contract_source_checkpoint.md` | WP4 pure handshake source checkpoint `c900d1ecb`: request/status/terminal, replay, trust-overlay, V158 admission, V159 success, runner/time/resource/artifact and branch binding; focused/adjacent/full verification, governed captures, synthetic externally-unchecked ceiling, zero real runtime/fit/authority effect, and next V160-style atomic-consumption design gate. |
| `CCAgentWorkSpace/Operator/2026-07-12--global_qualified_autonomous_learning_shadow_v1_wp4_trusted_issuer_isolated_runner_handshake_contract_source_checkpoint.md` | Operator mirror of handshake source acceptance, persistent G3/G4 failure, no real bytes/durable consumption/PG/runtime/fit/model/authority effect, and the design-only fixed atomic-coordinator next scope. |
| `CCAgentWorkSpace/PM/workspace/reports/2026-07-12--global_qualified_autonomous_learning_shadow_v1_wp4_v160_style_atomic_consumption_design_preauthoring_gate.md` | WP4 V160-style atomic-consumption design acceptance: phase-bound platform-attested Rust Ed25519 verifier receipt, six-action append-only coordinator, durable conflict oracle, success-only complete V159 atomic bundle, closed failure/expiry semantics, wrapper/ACL hard closure, final PA/FA/CC/E3/MIT 0/0/0, and zero source/runtime/fit/authority effect. |
| `CCAgentWorkSpace/Operator/2026-07-12--global_qualified_autonomous_learning_shadow_v1_wp4_v160_style_atomic_consumption_design_preauthoring_gate.md` | Operator mirror of the atomic-consumption design gate, production verifier and V160 still absent, G3/G4 failed, source authoring not yet authorized, and the read-only trusted-Ed25519-verifier source preauthoring next scope. |
| `CCAgentWorkSpace/PM/workspace/reports/2026-07-12--global_qualified_autonomous_learning_shadow_v1_wp4_trusted_ed25519_verifier_source_preauthoring_gate.md` | WP4 strict-Ed25519 verifier source-preauthoring acceptance: isolated non-engine crate, exact crypto/API/phase ownership, source-only unattested canonical receipt, total errors/allocation/Debug closure, same-process non-launderable future attestation, distinct-target offline and metadata/lock supply-chain proof, final PA/FA/CC/E3/MIT 0/0/0, and no source/runtime/fit/authority effect. |
| `CCAgentWorkSpace/Operator/2026-07-12--global_qualified_autonomous_learning_shadow_v1_wp4_trusted_ed25519_verifier_source_preauthoring_gate.md` | Operator mirror of the trusted-verifier source seam, exact nine-path next TDD scope, crate not yet fetched/compiled/attested, V160 and runtime still absent, G3/G4 failed, and all external/runtime/fit/authority work separately gated. |
| `CCAgentWorkSpace/PM/workspace/reports/2026-07-13--global_qualified_autonomous_learning_shadow_v1_wp4_trusted_ed25519_verifier_source_checkpoint.md` | WP4 trusted Ed25519 verifier source checkpoint `0b9038c78`: exact nine-path isolated crate/lock/scanner/CI implementation, source-only unattested ceiling, local Rust and metadata-aware/offline verification, E2/E3/E4 0/0/0, hosted run `29213814965` 8/8 SUCCESS, zero runtime/training/production rows, and direct V160 atomic-consumption source next state. |
| `CCAgentWorkSpace/Operator/2026-07-13--global_qualified_autonomous_learning_shadow_v1_wp4_trusted_ed25519_verifier_source_checkpoint.md` | Operator mirror of source checkpoint `0b9038c78`, CI run #1101, persistent G3/G4 failure and production proof/reward/model rows 0/0/0, no fit/model/registry claim, and no-new-design-gate V160 source handoff. |
...
| `CCAgentWorkSpace/PM/workspace/reports/2026-07-07--ai_ml_downstream_loop_wp6_reward_ledger_proofpacket_bridge.md` | PM downstream closure loop WP6 checkpoint：新增 source-only `reward_ledger_v1` bridge，只有 `PROOF_READY` ProofPacket + `STATUS_COUNTABLE` DemoMutationEnvelope 且 source lineage/hash 全可重算時才可形成 reward record；PA→E1/E2 rework cycles→E4→QA PASS；state=`ADVANCED_WITH_CONCERNS` and next source-safe item is WP7 effect-review stop loop。 |
| `CCAgentWorkSpace/Operator/2026-07-07--ai_ml_downstream_loop_wp6_reward_ledger_proofpacket_bridge.md` | Operator summary：WP6 source-only reward ledger bridge advanced with concerns; no runtime/DB/exchange/secret/order/Cost Gate/deploy/live/model reload/symlink/registry persistence/bounded Demo outcome ingestion; runtime/loss-control remains blocked and unconsumed。 |
| `CCAgentWorkSpace/PM/workspace/reports/2026-07-07--ai_ml_downstream_loop_wp7_learning_effect_review_stop_loop.md` | PM downstream closure loop WP7 checkpoint：新增 source-only `learning_effect_review_v1` stop-loop packet，支援 continue/rollback/rotate/stop/promote-review-only 且 ref/loss/authority fail-closed；PA→E1/E2 rework cycles→E4→QA PASS；state=`STOPPED` with `STOP_SOURCE_CLOSURE_COMPLETE_WAIT_RUNTIME`。 |
| `CCAgentWorkSpace/Operator/2026-07-07--ai_ml_downstream_loop_wp7_learning_effect_review_stop_loop.md` | Operator summary：AI/ML downstream source closure completed for WP2.1/WP3.1/WP6/WP7; runtime/loss-control and bounded Demo outcome branches remain blocked until exact PM→E3→BB READY scope。 |
| `CCAgentWorkSpace/E3/workspace/reports/2026-07-07--demo_test_runtime_loss_control_unblock_e3_review.md` | E3 report-only pre-review：operator assertion that runtime/loss-control was released is insufficient; latest PM packet remains `BLOCKED/STOP_LOSS_CONTROL`, engine env and standing auth blockers remain, BB dispatch is `NO`。 |
| `CCAgentWorkSpace/PM/workspace/reports/2026-07-07--demo_test_runtime_loss_control_unblock_pm_stop.md` | PM stop report：Demo test request blocked with `STOP_LOSS_CONTROL`; no runtime/DB/exchange/private/secret/order/Cost Gate/deploy/live/model reload/symlink/serving/bounded Demo action; next safe step is exact-scope PM→E3 runtime/env decision。 |
| `CCAgentWorkSpace/Operator/2026-07-07--demo_test_runtime_loss_control_unblock_pm_stop.md` | Operator summary：cannot proceed to Demo testing from operator assertion alone; requires Demo-only engine env restoration, readiness, guardrail/materialization, then BB-reviewed exact demo-test scope。 |
...
| `governance_dev/amendments/2026-07-08--AMD-2026-07-08-01-ibkr-phase2-external-contact-readonly.md` | Phase 2 AMD：授權 `stock_etf_cash` 進入 read-only 外部接觸（connection/account/positions/contract/market-data snapshots），gated by external-surface gate + readonly-probe；窄化修訂 SDK/socket 守衛只允許 Rust-owned 只讀 TWS 客戶端（loopback paper 4002）；G0.5 CI 守衛為 P0 前置；live/tiny-live/order-write/真錢仍禁。 |
...
| `archive/2026-07-09--execution_plan_v58_closed/2026-06-01--s2_gate_b_prelaunch_phase_transition_probe_plan.md` | S2 Gate-B PreLaunch phase-transition probe plan；定義 24h isolated public REST/WS probe、BTC controls、verdict labels、capture-only collector gates；真實 phase transition PASS 前 production collector IMPL 仍 blocked。|
...
| `archive/2026-07-09--execution_plan_v58_closed/2026-05-31--alpha_edge_regime_evidence_engineering_arrangement.md` | Alpha-Edge governance arrangement；現已指向 AEG-S0 formal closure，並保留 S1 limited-open 邊界。|
...
| 文件 | 内容 |
|------|------|
| `archive/2026-07-09--execution_plan_v58_closed/2026-05-26--alpha_tournament_ssot_spec.md` | ARCH-05 / Sprint 2 Alpha Tournament SSOT：補齊 v5.8 §4 implicit Alpha slot，固定讀取順序、候選池 A0-A5/B0、scoring contract、minimum evidence gates、Stage output、最小前置、role chain、跨文檔指針；文檔補丁不授權任何新 strategy、不放鬆 P0/Stage/5-gate。|
...
| 文件 | 内容 |
|------|------|
| `archive/2026-07-09--execution_plan_v58_closed/2026-05-22--autonomy_level_toggle_design_spec.md` | PA Layered Autonomy v2 — Autonomy Level Toggle 主 spec（1031 行；Conservative/Standard 雙層 + 5-gate switch + 24h cooldown + 三路通知 fail → 1h wait → SM-04 Defensive + 7d cooling + 6 cross-level invariant + 5 fail-safe hard requirements） |
...
| `archive/2026-07-09--execution_plan_v58_closed/specs/2026-05-22--v099-autonomy-level-config.md` | V099 autonomy_level_config schema spec（568 LOC；`system.autonomy_level_config` + `_switch_audit` + PG ENUM `autonomy_level_enum` + Cache PG LISTEN/NOTIFY） — Wave 5 cascade IMPL prerequisite |
...
| `archive/2026-07-09--execution_plan_v58_closed/2026-05-21--sprint_1a_dispatch_packet.md` | Sprint 1A-β PA dispatch packet（13 module spec land sub-phase + 7 必 ADR + 9 V### spec + runbook 派發排程） |
| `archive/2026-07-09--execution_plan_v58_closed/2026-05-21--v103_v104_earn_hypotheses_schema_spec.md` | V103/V104 Earn Hypotheses + Allocator Proposals schema spec（Sprint 1A-α MIT 940 行 baseline；M4 Self-Supervised Hypothesis Discovery 依賴源） |
| `archive/2026-07-09--execution_plan_v58_closed/2026-05-21--v103_v104_linux_pg_dry_run.md` | V103/V104 Linux PG dry-run protocol + 5-round empirical reflection + Guard A/B/C 驗證 |
...
| `archive/2026-07-09--execution_plan_v58_closed/2026-05-21--m4_minimum_bar_and_leakage_protocol.md` | M4 Pattern Miner minimum bar threshold + leakage protocol（hypothesis discovery 防 data leak + null-result acceptance + shift(1) 三語言） |
| `archive/2026-07-09--execution_plan_v58_closed/2026-05-21--m11_threshold_m7_dedup_decay_enforced_rename.md` | M11 threshold rename + M7 dedup decay enforced（continuous replay 與 model decay 接線去重；per CR-7 contract） |
| `archive/2026-07-09--execution_plan_v58_closed/2026-05-21--m1_lal_layered_approval_lease_design_spec.md` | M1 LAL Layered Approval Lease module DESIGN spec（697 行；Tier 0-4 升降 / 24h undo / Decision Lease retrofit / ADR-0034 對應 module 行為層 spec）— SPEC-DRAFT-V0 (IMPL pending Sprint 1A-γ+；per 2026-05-21 acceptance audit) |
| `archive/2026-07-09--execution_plan_v58_closed/2026-05-21--m2_overlay_state_machine_design_spec.md` | M2 Overlay Enable / Disable state machine module DESIGN spec（macro / on-chain / regime 三類 overlay 治理；5-state FSM × 5 trigger_type；V105 schema 已 land）— DESIGN-DRAFT (Sprint 1A-γ 派發；IMPL pending E1 Sprint 5+) |
| `archive/2026-07-09--execution_plan_v58_closed/2026-05-21--m3_health_monitoring_design_spec.md` | M3 self-monitoring / auto-diagnostics / health-aware degradation module DESIGN spec（648 行；4-state ladder + 6 health domain + amplification cap；對應 V106 schema spec）— DESIGN-DRAFT (IMPL pending Sprint 1A-γ+；ADR 待 Sprint 1A-γ R4 cross-ADR audit 補) |
| `archive/2026-07-09--execution_plan_v58_closed/2026-05-21--m4_hypothesis_discovery_design_spec.md` | M4 Hypothesis Discovery — self-supervised pattern mining module DESIGN spec（Cowork DRAFT-only 邊界 + V103 EXTEND + shift(1) leak-free）— SPEC-DRAFT-V0 (Sprint 1A-γ 派發；DRAFT writeback 在 protected scope 邊界) |
| `archive/2026-07-09--execution_plan_v58_closed/2026-05-21--m6_bayesian_reward_weight_design_spec.md` | M6 Bayesian Reward Weight Tuning module DESIGN spec（849 行；GP kernel + acquisition function + iter budget + 30% rollback cap；對應 V110 schema spec）— SPEC-DRAFT-V1 (IMPL pending Sprint 1A-γ+；ADR 待補) |
| `archive/2026-07-09--execution_plan_v58_closed/2026-05-21--m7_decay_enforced_design_spec.md` | M7 Decay Detection + Single Decay Authority + DECAY_ENFORCED lifecycle module DESIGN spec（463 行；4 source × 6 FSM；14d × 50% per-strategy 動態；對應 V113 schema spec；QC consultant draft + PM transcribe）— SPEC-DRAFT-V0 (IMPL pending Sprint 1A-γ+；ADR 待補) |
| `archive/2026-07-09--execution_plan_v58_closed/2026-05-21--m9_ab_framework_design_spec.md` | M9 A/B Testing Framework module DESIGN spec（4 variant cluster × i.i.d. 修正 × variant Stage 路徑 + fair execution clause；對應 V108 schema spec + ADR-0037）— SPEC-DRAFT-V1 (Sprint 1A-γ 派發；Sprint 4 read-only logging / Sprint 7-8 manual A/B / Y2 auto-gate 分階段 IMPL) |
| `archive/2026-07-09--execution_plan_v58_closed/2026-05-21--m11_continuous_counterfactual_replay_design_spec.md` | M11 Continuous Counterfactual Replay module DESIGN spec（619 行；nightly replay divergence 5-7 type × 4-level severity + self-hosted PG `market.liquidations` source；對應 V107 schema spec + ADR-0038）— SPEC-DRAFT-V0 (IMPL pending Sprint 1A-γ+) |
| `archive/2026-07-09--execution_plan_v58_closed/2026-05-21--v105_m2_overlay_state_transitions_schema_spec.md` | V105 M2 overlay state transitions schema spec（5 值 state enum + from/to + trigger_type + counterfactual_log FK + engine_mode CHECK） |
| `archive/2026-07-09--execution_plan_v58_closed/2026-05-21--v106_m3_health_observations_schema_spec.md` | V106 M3 health observations schema spec（health domain 6 column + hypertable + 7d chunk + 30d compression） |
| `archive/2026-07-09--execution_plan_v58_closed/2026-05-21--v107_m11_replay_divergence_log_schema_spec.md` | V107 M11 replay divergence log schema spec（divergence_type / divergence_pnl_usdt / fill_chain_id FK + ~9k row/yr 規模） |
| `archive/2026-07-09--execution_plan_v58_closed/2026-05-21--v108_m9_ab_testing_framework_schema_spec.md` | V108 M9 A/B testing framework schema spec（preregistration FK to V103 + hash algorithm + mSPRT schema） |
...
| `archive/2026-07-09--execution_plan_v58_closed/2026-05-21--v110_m6_reward_weight_history_schema_spec.md` | V110 M6 reward weight history schema spec（5 λ 值 5 column vs JSONB + bayesian_opt 算法欄位） |
| `archive/2026-07-09--execution_plan_v58_closed/2026-05-21--v111_m10_discovery_tier_config_schema_spec.md` | V111 M10 discovery tier config schema spec（Tier A-E 5 行 config + capital threshold 7 級 trigger + activation log） |
| `archive/2026-07-09--execution_plan_v58_closed/2026-05-21--v112_m1_decision_lease_lal_tiers_schema_spec.md` | V112 M1 Decision Lease LAL tiers schema spec（Tier 0-4 enum + eligibility materialized view + auto-approve toggle；依賴 ADR-0034） |
| `archive/2026-07-09--execution_plan_v58_closed/2026-05-21--v113_m7_decay_signals_schema_spec.md` | V113 M7 decay signals schema spec（lifecycle 6 值 enum + 4 signal column） |
...
| 文件 | 内容 |
|------|------|
| `archive/2026-07-09--execution_plan_v58_closed/2026-05-21--m2_overlay_state_machine_design_spec.md` | M2 Overlay State Machine DESIGN spec (904 行；5-state FSM + dwell time + flap suppression；Sprint 1A-γ PA) |
| `archive/2026-07-09--execution_plan_v58_closed/2026-05-21--m4_hypothesis_discovery_design_spec.md` | M4 Hypothesis Discovery + V103 EXTEND outline + Cowork hybrid path DESIGN spec (877 行；6 attribute minimum bar + DRAFT writeback；governance authority ADR-0045 reserved per R4 C-1) |
...
| `archive/2026-07-09--execution_plan_v58_closed/2026-05-21--m9_ab_framework_design_spec.md` | M9 A/B Framework DESIGN spec (775 行；4 variant cluster + variant Stage 路徑 + mSPRT + AVI) |
| `archive/2026-07-09--execution_plan_v58_closed/2026-05-21--m10_discovery_tier_design_spec.md` | M10 Discovery Tier DESIGN spec (~990 行；Tier A-E + capital threshold 7 級 + Tier D 黑名單) |
| `archive/2026-07-09--execution_plan_v58_closed/2026-05-21--v105_m2_overlay_state_transitions_schema_spec.md` | V105 M2 overlay state transitions full DDL (1395 行) |
| `archive/2026-07-09--execution_plan_v58_closed/2026-05-21--v108_m9_ab_testing_framework_schema_spec.md` | V108 M9 A/B testing framework full DDL (1508 行；3 table) |
...
| `archive/2026-07-09--execution_plan_v58_closed/2026-05-21--v111_m10_discovery_tier_config_schema_spec.md` | V111 M10 discovery tier config full DDL (1471 行) |
...
| `archive/2026-07-09--execution_plan_v58_closed/2026-05-21--v114_m5_model_versions_streaming_schema_spec.md` | V114 M5 EXTEND `learning.model_versions` PLACEHOLDER (190 行；ADR-0035 Decision 2 對齊；KEEP per R4 dedup) |
| `archive/2026-07-09--execution_plan_v58_closed/2026-05-21--v115_m12_order_router_audit_schema_spec.md` | V115 M12 OrderRouter Adaptive Routing Audit PLACEHOLDER (288 行；ADR-0039 §Decision 3；KEEP per R4 dedup) |
...
| `archive/2026-07-09--execution_plan_v58_closed/2026-05-21--v116_m13_asset_venue_dim_schema_spec.md` | V116 asset/venue dim（288 行；reference.asset_class_dim + venue_dim + Y1 seed）；**R4 dedup KEEP active 版本** |

### 2026-05-21 Sprint 1A-ε deliverables (4 spec; R4+CC+PA+MIT 三化審計)

| 文件 | 内容 |
|------|------|
| `archive/2026-07-09--execution_plan_v58_closed/2026-05-21--v099_v116_migration_ordering_audit_and_dry_run_sop.md` | V099-V116 migration ordering audit + 12 V### Linux PG dry-run SOP (1223 行；18 V### overview + dependency graph + sqlx checksum repair + 1e-4 fixture harness；MIT) |
| `archive/2026-07-09--execution_plan_v58_closed/2026-05-21--mac_ci_13_module_cross_compile_verify_scope_spec.md` | Mac CI 13-module cross-compile verify scope spec (598 行；PR + 週一 cron + 2000 min/月 budget；E5) |
| `archive/2026-07-09--execution_plan_v58_closed/2026-05-21--monthly_review_wizard_and_lv3_4_modal_helper_scope_spec.md` | Monthly Operator Review Wizard + Lv 3-4 Modal Helper scope spec (520+ 行；A3 inline draft a12c302e → PM transcribed；8 surface + 7 AC + 8 INV；A3) |
| `archive/2026-07-09--execution_plan_v58_closed/2026-05-21--v103_extend_m4_hypothesis_columns_schema_spec.md` | V103 EXTEND M4 hypothesis discovery 6 column full DDL (MIT inline a4d52063 → PM transcribed；Gap I-A patch；Guard B 6 段 + Linux PG dry-run × 2 round + 3 hot-path index；待 PM Q1 V### naming verdict + DEFAULT 'OPERATOR' vs 'M4_AUTO' 拍板) |
