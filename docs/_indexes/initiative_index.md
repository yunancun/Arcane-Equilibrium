...
|---|---|---|
| IBKR Stock/ETF paper + shadow lane | 尚未進 `TODO.md` active queue；第三輪已條件式確認 all-gates-pass 後 `paper_shadow_only` 可簽核完整上線；需 operator 批准 Phase 0 ADR/AMD + named contract packet 後才可進任何 implementation | `docs/execution_plan/2026-06-29--ibkr_stock_etf_paper_shadow_development_arrangement.md`; `docs/CCAgentWorkSpace/PM/workspace/reports/2026-06-29--ibkr_stock_etf_plan_round2_pm_integration.md`; `docs/CCAgentWorkSpace/PM/workspace/reports/2026-06-29--ibkr_stock_etf_plan_round3_pm_launch_certification.md` |
