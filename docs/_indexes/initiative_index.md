...
| P5-SM IPC convergence | `TODO.md` row `P5-SM-OPTION2-CONVERGENCE` | `docs/CCAgentWorkSpace/CC/workspace/reports/2026-06-11--p5sm_soak_infra_compliance.md` plus latest PM runtime notes in `TODO.md` |
