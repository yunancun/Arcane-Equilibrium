...
|---|---|---|
| IBKR Stock/ETF paper + shadow lane | Phase 0 ADR/AMD + named contract packet 已落地為 paper/shadow governance baseline；下一步只允許 Phase 1 type/config/schema/IPC source foundation with default-OFF flags and denial tests，不允許 IBKR API/secret/connector/runtime/evidence clock | `docs/adr/0048-ibkr-stock-etf-paper-shadow-lane.md`; `docs/governance_dev/amendments/2026-06-29--AMD-2026-06-29-01-ibkr-stock-etf-paper-shadow-lane.md`; `docs/execution_plan/specs/2026-06-29--stock_etf_cash_phase0_named_contract_packet.md`; `docs/execution_plan/2026-06-29--ibkr_stock_etf_paper_shadow_development_arrangement.md`; `docs/CCAgentWorkSpace/PM/workspace/reports/2026-06-29--ibkr_stock_etf_plan_round3_pm_launch_certification.md` |
