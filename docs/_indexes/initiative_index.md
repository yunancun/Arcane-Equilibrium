...
|---|---|---|
| IBKR Stock/ETF paper + shadow lane | 尚未進 `TODO.md` active queue；需 operator 批准 Phase 0 ADR/spec 後才開工 | `docs/execution_plan/2026-06-29--ibkr_stock_etf_paper_shadow_development_arrangement.md` |
