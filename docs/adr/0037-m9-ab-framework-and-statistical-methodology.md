...
- **Cluster 2 signal source swap 依賴 M4 land** — Sprint 7-8 IMPL 受 M4 stage 1 (Sprint 2-3) 進度影響；mitigation = M4 spec doc `docs/execution_plan/2026-05-21--m4_minimum_bar_and_leakage_protocol.md` 已 land；M4 stage 1 開展正常即不阻 Cluster 2
