...
**Last Updated:** 2026-06-29 (ADR-0048 + AMD-2026-06-29-01 IBKR stock/ETF paper/shadow lane)
...
| ADR-0048 | IBKR Stock/ETF Paper + Shadow Lane | docs/adr/0048-ibkr-stock-etf-paper-shadow-lane.md | ✅ Active | Accepts `stock_etf_cash` as an isolated IBKR read-only / paper / shadow research lane under Phase 0 named contracts; preserves Bybit active live execution as the only live venue and denies IBKR live/tiny-live/margin/short/options/CFD/transfer. |
