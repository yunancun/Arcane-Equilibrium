...
> **IBKR current-policy correction (2026-07-11).** AMD-2026-07-11-01 is the
> controlling policy for `stock_etf_cash`: readonly/paper/shadow/tiny-live/live
> capability development is allowed, but all real contact/effects remain
> inactive until Rust validates the bound, expiring `ibkr_activation_envelope_v1`.
> Any older ADR-0048 / AMD-2026-06-29-01 / AMD-2026-07-08-01 row that describes
> live-capability development as denied is historical and superseded in part;
> credentials/session never auto-activate and product/Python-authority denials
> remain binding.

| Historical artifact | Current standing | Current capability interpretation |
|---|---|---|
| AMD-2026-06-29-01 | **Superseded in part / historical** | Its paper/shadow-only and live-capability-development denials are replaced by AMD-2026-07-11-01. Its lane isolation and permanent product/Python-authority denials remain binding. |
| AMD-2026-07-08-01 | **Superseded in part / historical** | Its readonly-only, paper-loopback-only, live-port/live-slot, and no-order capability-development denials are replaced by AMD-2026-07-11-01. Real contact remains inactive until the Rust-validated activation envelope is present. |
| AMD-2026-07-09-01 | **Superseded before acceptance / never in force** | It grants no independent credential-write authority; the 2026-07-11 policy still requires explicit activation and never accepts credential/session auto-activation. |

The older detail rows below preserve contemporaneous evidence only. Their legacy
`Active` label must not be read as current policy where this projection or
AMD-2026-07-11-01 says `Superseded in part / historical`.
...
| AMD-2026-05-03-01 | REF-20 V3 §11 P5 entry · Workplan V1 §6 hard prereq #7 | `docs/governance_dev/amendments/2026-05-03--ref20_wave7_p5_impl_accept_deploy_blocked.md` | 2026-05-03 | **Active** — IMPL accept-in-tree + deploy-time gate retained。關閉 2026-05-03 PM session Wave 7 P5 hard-prereq silent override drift（commit `c887e4e` 與同日 defer note 24h 內互相矛盾）；`LG-2/3/4 frontend merged + 7d stable` 仍為 deploy-time gate。8-agent cold audit verdict 後合成。|
...
| AMD-2026-05-09-04 | SM-04 · LG-X-01 · DOC-01 §5.5/§5.7 · ADR-0021 (proposed) · V079 migration | `docs/governance_dev/amendments/2026-05-09--demo_promotion_evidence_push.md` | 2026-05-09 | **Active** — Demo→LivePending Promotion Evidence Push。commit `48227607`：edge_estimator hourly promotion_evidence producer 推 selection_bias + tail_risk 進 `learning.strategy_trial_ledger`；V079 migration 持久化 per-strategy/symbol `trial_sharpes`；promotion gate 改讀真實 evidence ledger 非 in-memory transient state。|
| AMD-2026-05-09-03※ | EX-06 Strategist Agent · DOC-01 §5.4/§5.11 · ADR-0021 (proposed) · AMD-2026-05-09-02 | `docs/governance_dev/amendments/2026-05-09--strategist_wide_adjustment_skill.md` | 2026-05-09 | **Active** — Strategist `wide_parameter_adjustment` skill：commit `c2ab7b1a` 把 per-cycle `max_param_delta_pct` 30%→50%（freedom-not-gate；`RuntimeMaxEnvelope` 硬頂不變，P0/P1 floor 不受影響；不加前置 supervised gate）。**※ 檔頭自標碼 `AMD-2026-05-09-03`，與同號 graduated-canary-default 撞號；此技能亦登記為 ADR-0022。**|
| AMD-2026-05-10-03 | TODO v19 §5.1 invariant 5 · W-AUDIT-4b ML 基座 | `docs/governance_dev/amendments/2026-05-10--AMD-2026-05-10-03-invariant-5-wording-n0-scope.md` | 2026-05-10 | **Accepted**（option A per operator 2026-05-10 sign-off；commit `0b9a03ef` land）— invariant 5 wording 對齊 N+0 actual IMPL（feature_baselines → mlde_edge_training_rows → scorer_predictions → 3 advisor 並行）+ invariant 5b N+1 預告。|
| AMD-2026-05-10-04 | AMD-2026-05-09-03 §2.3 (historical) · AMD-2026-05-15-01 · ARCH-04 §2 · TODO v19 §5.1 invariant 4 | `docs/governance_dev/amendments/2026-05-10--AMD-2026-05-10-04-toml-drift-fix-sop.md` | 2026-05-10 | **Accepted**（option B-later per operator 2026-05-10 拍板）— TOML Drift Gap 治理 SOP。2026-05-23 active note：僅保留 TOML drift 機制；舊 paper Stage 1 launch wording obsolete，launch 須用 Stage 0R Replay Preflight evidence + Stage 1 `Environment::Demo` micro-canary。|
| AMD-2026-05-10-05 | AMD-2026-05-09-03 §2.2 (5-stage 表) · §4.1 healthcheck `[58]` · §4.5 manual_promote Decision Lease | `docs/governance_dev/amendments/2026-05-10--AMD-2026-05-10-05-canary-stage-criteria-spec.md` | 2026-05-10 | **Drafted** — 待 PA + QC + PM sign-off。Graduated Canary Stage promote/rollback 條件寫死（AND/OR / sample-size floor / wall-clock floor / 字段檢查）。2026-05-23 active rebase：僅 refine metric thresholds；Stage 1 為 Stage 0R 後的 `Environment::Demo`，paper output 不算 promotion evidence。|
| AMD-2026-05-11-W6-1 | W6-1 RFC final verdict draft · W6 sub-task chain W6-1~W6-10 | `docs/governance_dev/amendments/2026-05-11--AMD-2026-05-11-W6-1-rfc-final-verdict-absorb.md` | 2026-05-11 | ✅ **ACCEPTED** — Operator final approval 2026-05-11 path B。W6-1 RFC final verdict 4 verdict + 三角 sign-off 14 push-back items 統合為正式 governance amendment（PA `2afd76d6` + QC + MIT `be947fe3` + 3 PB absorb `89f9aad0` + PM consolidate `7f0b6940` 全 APPROVE）。|
...
| AMD-2026-05-XX-XX (phys_lock)† | EDGE-P2-3 Phase 2c-PL · DOC-01 §5.4/5.5/5.6/5.8/5.16 · DOC-08 §12 · `risk_config_live.toml [exit]` carve-out | `docs/governance_dev/amendments/2026-05-XX-XX-phys-lock-live-enable-draft.md` | 2026-05-18 (v0.3) | **DRAFT v0.3 — NOT LANDED** — phys_lock LiveDemo Enable。pending (a) Phase 2b LiveDemo 7d PASS；(b) QC counterfactual demo canonical-window PASS；(c) Phase 2c-PL cumulative ≥60-86 fires PASS + escalation rule；(d) operator sign-off；(e) AMD slot 編號補實。**† 檔頭自標「暫不入 register（draft-only；slot 補實後再登）」；此行僅為 2026-07-09 audit 完整性登記，slot 未定。**|
| AMD-2026-05-20-01 | `srv/2026-05-20--dual-track-architecture-v4.md`（規劃權威）· TODO §1 banner · §4.1 wave roster | `docs/governance_dev/amendments/2026-05-20--AMD-2026-05-20-01-dual-track-architecture.md` | 2026-05-20 | **Accepted**（planning + sprint banner authority；ADR-0025/0026 + V101/V102 同日批准）→ 後由 AMD-2026-05-20-02/03/04 雙軌制→evidence-sprint chain 逐步 supersede（AMD-04 header 明文 supersede AMD-01+02+03）。Dual-Track（Direct Exploit + ASDS Factory）。|
| AMD-2026-05-20-02 | `srv/2026-05-20--dual-track-architecture-v4.1.md` · 修訂 AMD-05-20-01 + ADR-0025/0026 v1 + V101/V102 v1 | `docs/governance_dev/amendments/2026-05-20--AMD-2026-05-20-02-v4.1-reviewer-corrections.md` | 2026-05-20 | **Accepted**（planning authority）→ 後由 AMD-05-20-03/04 supersede。v4.1 reviewer corrections（5 critique + 2 push-back；capacity 60/30/10→50/10/40 + LCS-first；fake table names→grep-verified real names）。|
| AMD-2026-05-20-03 | `srv/2026-05-20--dual-track-architecture-v4.2.md` · 修訂 AMD-05-20-01/02 + ADR-0025/0026 v2 + V101/V102 v2 | `docs/governance_dev/amendments/2026-05-20--AMD-2026-05-20-03-v4.2-second-reviewer-corrections.md` | 2026-05-20 | **Accepted**（planning authority）→ 後由 AMD-05-20-04 supersede。v4.2 second reviewer corrections（9 accept + 1 push-back；9→12 表 + 真實 column names；capacity 50/10/40→60/0/40；prereg +8 fields；replay match DEFER）。|
| AMD-2026-05-20-04 | `srv/2026-05-20--commercial-evidence-sprint-v4.3.md` · 修訂 AMD-05-20-01/02/03 | `docs/governance_dev/amendments/2026-05-20--AMD-2026-05-20-04-v4.3-commercial-evidence-sprint.md` | 2026-05-20 | **Superseded** — v4.3 Commercial Evidence Sprint Reframe（雙軌制降級為 8-12 週商業證據衝刺）。§1 Stream 2 superseded by AMD-2026-05-25-01 (2026-05-27)；§1 Stream 3 superseded by AMD-2026-05-20-05；§1 Stream 1 only retain（capacity 100% per AMD-25-01）。|
| AMD-2026-05-20-05 | `srv/2026-05-20--commercial-evidence-sprint-v4.3.md` (in-place retraction) · 修訂 AMD-05-20-04 §1 | `docs/governance_dev/amendments/2026-05-20--AMD-2026-05-20-05-retract-stream-3-ip-sale.md` | 2026-05-20 | **Active (Stream 3 retract) / partial Superseded** — Operator reality check：IP sale 不現實 → v4.3 Stream 3 IP Sale Prep 整段 retract（結論 Active）；§1「Stream 2 維持 30%」部分 OBSOLETED / superseded by AMD-2026-05-25-01 (2026-05-27)。|
...
| AMD-2026-06-29-01 | ADR-0006 (Bybit-only baseline) · ADR-0033/0040 (registered non-Bybit exception pattern) · ADR-0048 (IBKR stock/ETF paper/shadow lane) · TODO IBKR Phase 0/1 gates | `docs/governance_dev/amendments/2026-06-29--AMD-2026-06-29-01-ibkr-stock-etf-paper-shadow-lane.md` | 2026-06-29 | **Active** — IBKR `stock_etf_cash` paper/shadow research lane boundary。Bybit remains the only active live execution exchange；IBKR is limited to read-only / paper / shadow contracts under ADR-0048 and the Phase 0 named contract packet。`stock_etf_phase0_contract_packet_manifest_v1` now source-validates schema/status/scope, ADR/AMD/packet paths, loopback paper API baseline, global denials, exact named contract list including `instrument_identity_contract_v1`, `stock_etf_pit_universe_contract_v1`, `stock_etf_strategy_hypothesis_contract_v1`, `stock_etf_risk_policy_v1`, and `lane_scoped_ipc_v1`, and phase unlock table while rejecting prior contact, live-port allowance, contract drift, missing denials, evidence-clock/GUI/runtime/release/tiny-live/live unlock claims；`broker_capability_registry_v1` now source-validates the complete operation matrix, Bybit live unchanged, Python broker writes denied, paper writes Rust-owned/gated, `lane_scoped_ipc_v1` and `stock_etf_risk_policy_v1` required for paper write rows, risk policy gates required for shadow/scorecard rows, and exact typed denials for live/margin/short/options/CFD/transfer/account writes without contact or secret serialization；`lane_scoped_ipc_v1` now source-validates the exact `stock_etf.*` IPC method matrix, required gates including `stock_etf_risk_policy_v1`, request fields, typed denials, Rust-owned paper effect methods, Python forward-only posture, Bybit IPC path separation, and no IBKR contact/connector/secret/runtime authority；Python no-write static guard now AST-scans Stock/ETF/IBKR route and real inert connector skeleton files, excluding existing Bybit modules, and rejects direct broker write methods/calls, forbidden paper-order IPC strings, direct `ibapi` / `ib_insync` imports, and non-GET Stock/ETF/IBKR routes until a later Rust-authority contract revises the boundary；`instrument_identity_contract_v1` now source-validates point-in-time Stock/ETF/Cash identity, closed listing/primary-exchange/currency/tradability/PRIIPs states, market-calendar and contract-detail hashes, corporate-action version, Bybit-live unchanged proof, and typed live/margin-short/options-CFD denials while rejecting crypto/CFD, unknown venues, non-USD v1 currency, untradable instruments, prior contact, and secret serialization；`stock_etf_pit_universe_contract_v1` now source-validates point-in-time universe membership, bounded constituents, per-constituent identity/tradability/PRIIPs/currency/venue checks, screen/policy hashes, survivorship controls, freeze state, Bybit-live unchanged proof, and IBKR-live denial while rejecting crypto/CFD/cash constituents, unknown venues, non-USD v1 currency, untradable constituents, prior contact, and secret serialization；`stock_etf_strategy_hypothesis_contract_v1` now source-validates pre-registered paper/shadow strategy hypotheses, allowed low/medium-turnover families, daily/weekly timeframe, PIT universe/benchmark/cost/rule/feature/statistical/preregistration hashes, bias and multiple-testing controls, benchmark-relative after-cost metrics, forbidden-instrument denials, Bybit-live unchanged proof, and IBKR-live denial while rejecting high-frequency/event-driven reserved families, premature profitability claims, live/tiny-live claims, prior contact, and secret serialization；`stock_etf_risk_policy_v1` now source-validates the dormant Stock/ETF paper risk config, cash-only no-margin/no-short/no-options/no-CFD/no-transfer/no-live controls, finite ordered notional caps, bounded open-order/open-position limits, required stock/ETF/cash universe and denied crypto/CFD kinds, cost model prerequisites, paper-order gates, Bybit-live unchanged proof, and no IBKR contact/connector/secret serialization；Phase 1 DB evidence DDL source contract now validates required broker/research/audit schemas, stock/ETF evidence tables, natural keys, lane/broker/live-denial constraints, paper/shadow separation, Guard A/B/C migration controls, and future PG dry-run/double-apply requirements while rejecting migration apply, PG write, sqlx registration, and PM/Operator apply authorization claims；Phase 2 immutable artifact candidates must embed validated secret-slot and API topology runtime evidence, and missing/mismatched evidence remains a first-contact blocker；feature flags alone cannot grant paper/live authority without validated secret/artifact/session/envelope evidence；paper lifecycle evidence is append-only and transition-validated before any future paper route；`audit.asset_lane_events_v1` now validates immutable cross-phase event references without writing audit rows or applying DDL；Phase 3 PASS_DAY / QUARANTINED_DAY evidence-clock checker semantics are source-defined but not started；Phase 3 scorecard input contracts validate cash ledger, cost model, benchmark, shadow fill, storage capacity, and derived-only bundle shape without importing fills or writing scorecards；Phase 4 GUI readiness is display-only and fail-closed through `/api/v1/stock-etf/readiness` with no POST/order/secret/contact/lane-selector authority；`gui_lane_contract_v1` now source-validates GET-only display, client lane state untrusted, route/cache/auth partition, stale-cache cross-lane denial, crypto tab and Decision Lease/risk regression evidence, and no IBKR contact/secret serialization；`stock_etf_kill_switch_and_disable_cleanup_runbook_v1` now source-validates exact disable flags, collector stop, GUI disabled/hidden posture, live-secret absence, forward-only archive/DB retention, append-only audit, and Bybit live unchanged while rejecting contact, connector runtime, paper orders, secret creation/serialization, destructive cleanup, release authority, tiny-live, and live；Phase 5 release packet contract is machine-checkable but source-only and still does not authorize release, paper-shadow clock start, connector runtime, tiny-live, or live；`tiny_live_adr_eligibility_v1` is a discussion-only contract and explicitly rejects tiny-live/live authorization values。Denies IBKR live/tiny-live/margin/short/options/CFD/transfer/account-management writes, Python broker write authority, GUI lane authority, and automatic promotion。|
| AMD-2026-07-04-01 | DOC-06（變更治理）· DOC-07（審計持久化）· CLAUDE.md §Git And Sync · 根原則 8/12 | `docs/governance_dev/amendments/2026-07-04--AMD-2026-07-04-01-doc06-runtime-mutation-record-rule.md` | 2026-07-04 | **Active** — DOC-06 Runtime Mutation 紀錄規則泛化。把 FA F2 對 crontab 提的「before/after + sha 記錄」要求泛化為 DOC-06 通用條款 RM-1..RM-4，適用所有 runtime mutation（crontab / git reset / restart / SSOT 遷移 / env / PG 調參 / cron pin）：RM-1 執行前後留 before/after 快照 + manifest（時間戳/操作者/類型/對象/動機/before_sha/after_sha/revert 路徑）；RM-2 快照不得只落 boot-volatile `/tmp`（承 FA F1）；RM-3 移除類 mutation 須顯式裁決恢復/退役 + owner（無裁決地移除 = 與功能缺失同級，承 FA F2）；RM-4 pin 優先 pin-by-reference（承 FA F4）。治理條款泛化，執行器實作 owner 待 PA；不改 DOC-06 源正本條文，以 amendment 形式登記。TW drafted per R4 cold-audit R2 + CC「DOC-06 缺口」finding。|
| AMD-2026-07-08-01 | ADR-0048 · AMD-2026-06-29-01 (extends) · ADR-0033/0040 · TODO IBKR Phase 2 gates | `docs/governance_dev/amendments/2026-07-08--AMD-2026-07-08-01-ibkr-phase2-external-contact-readonly.md` | 2026-07-08 | **Active** — IBKR `stock_etf_cash` Phase 2 read-only external-contact authorization。授權從 source-only Phase 0/1 進入 Phase 2 read-only IBKR 接觸（connection health / account / positions / contract details / market-data snapshots），gated by `phase2_ibkr_external_surface_gate_v1` PASS + `stock_etf_ibkr_readonly_probe_request_v1`。窄化修訂 SDK/socket 靜態守衛硬邊界，只允許 `openclaw_engine` 內一個 Rust-owned read-only TWS API client（IB Gateway paper loopback 4002）；Python no-write/no-SDK 守衛與 `openclaw_types` net-free 守衛不變；live ports 4001/7496 + Client Portal Web API 仍 denied。要求 `stock-etf-static-guards` CI job（G0.5）green 為 P0 前置。Gated sequence G0→G0.5→P0..P6 + 獨立 Phase 4 GUI runtime。不變量不鬆動：IBKR live/tiny-live categorically denied、zero real money、no order-write（含 paper）、no fake-success、live secret slot absent、env-var fallback denied、Bybit path unchanged、read-only 階段 no DB migration、no auto-promotion。CC/FA `CERTIFIABLE_IF_GATES_PASS` · PA FEASIBLE · Operator Accepted 2026-07-08。2026-07-09 post-acceptance clarification (non-substantive, CC-ruled): Secret Boundary `$OPENCLAW_SECRETS_DIR` = secrets-root; P1 fingerprint-only loader resolves IBKR base via a distinct `OPENCLAW_SECRETS_ROOT` locator (must not overload the bybit `OPENCLAW_SECRETS_DIR`) → `<secrets-root>/external/ibkr/{readonly,paper}` (trade-core: `/home/ncyu/BybitOpenClaw/secrets/external/ibkr`), live absent; protected quantities unchanged, no re-approval required (Operator ack only)。2026-07-09 clarification #2 (CC-ruled): P2 read-only seal approval model = option A owner-only approval file + 6 bindings; mandatory upgrade trigger to option B (HMAC, authorization.json-grade) = any paper order-write / `tiny_live_adr_eligibility_v1` discussion / capital exposure。2026-07-15 clarification #3 (CC-ruled, IBKR loop R2): W2 controlled-seal 控制批准綁定 = `ibkr_phase2_seal_control_v1 ∧ authorization_amd==AMD-2026-07-11-01`(ADR/AMD 出典由 artifact 層硬 pin);審計重算配方 + EA3 每次 apply 前歸檔批准檔精確位元組義務;Operator acknowledged 2026-07-16。|

| AMD-2026-07-11-01 | ADR-0048 · AMD-2026-06-29-01/2026-07-08-01 (partial supersession) · TODO `P0-IBKR-STOCK-ETF-FULL-LIVE-CAPABILITY-W1` | `docs/governance_dev/amendments/2026-07-11--AMD-2026-07-11-01-ibkr-stock-etf-full-live-capability-development.md` | 2026-07-11 | **Accepted** — authorizes complete no-contact `stock_etf_cash` readonly/paper/shadow/tiny-live/live capability development, including production wiring, Rust-owned lifecycle/risk authority, IPC/GUI, fake-TWS, and inactive deployment. It does **not** authorize broker contact or effects: default is inactive and missing credentials/session/entitlement/activation is `EXTERNAL_VERIFICATION_PENDING`. Real contact requires a Rust-validated, time-bounded, commit/account/session-bound `ibkr_activation_envelope_v1` plus Guardian, Decision Lease, global Cost Gate, limits, kill-switch, reconciliation, and audit checks. Credentials/session never auto-activate. Margin/short/options/CFD/transfer/account-management writes and all Python order/risk/activation authority remain denied; Bybit behavior is unchanged. |
...
| AMD-2026-07-21-01 | ADR-0035 · ADR-0049 · ADR-0051 · AIML-LONG-LIVED-LANDING-V2 S0.2 | `docs/governance_dev/amendments/2026-07-21--AMD-2026-07-21-01-aiml-advisory-serving-authority.md` | 2026-07-21 | **Accepted — S0.2 source-policy authority; no runtime/adoption effect** — defines the future advisory-only, registry-authorized, hash-bound Rust consumer while preserving ALR/trainer/controller/challenger no-serving/no-promotion and all direct-trading denials. The immutable S0.3 dependency is `docs/execution_plan/ai_ml_landing/receipts/S0.2-serving-authority-receipt-v1.json`; S0.3 must consume it rather than infer adoption from policy status. S0.2 grants no runtime/deploy/PG/broker/order effect, implements no ML5/ML6 and cannot claim `PROGRAM_ADOPTED`. |

---

### ADR-0048 2026-06-30 Addendum

`stock_etf_reference_data_sources_v1` is now part of the ADR-0048 named
contract packet. It source-validates corporate-action, FX, fee, tax/FTT, and
withholding-treatment source-as-of records, required hashes, USD v1 currency
treatment, evidence-clock freeze, Bybit-live unchanged proof, and no IBKR
contact / connector runtime / secret serialization / tiny-live / live
authority. Phase 0 manifest, Phase 3 frozen-input validation, shadow-fill
reconstruction gates, and scorecard gates now require the reference-data source
contract hash.

### ADR-0048 2026-06-30 Addendum B

`stock_market_data_provenance_v1` is now hardened as a machine-checkable
source validator inside the Phase 3 evidence contract surface. It validates
contract id/version, `stock_etf_cash` / IBKR lane binding, read-only/paper/
shadow environment, vendor/entitlement, payload and source artifact hashes,
received/exchange timestamps, adjustment marker, instrument identity hash,
calendar session id, Bybit-live unchanged proof, and no IBKR contact /
...
### ADR-0048 2026-06-30 Addendum E

Phase 3/5 lineage is now explicit across paper-shadow reconciliation,
scorecard derivation, scorecard verdict, and future tiny-live ADR discussion.
`stock_etf_scorecard_derivation_v1` validates source-only derived artifact
lineage from input bundle, evidence/DQ manifests, paper-shadow reconciliation,
formula/preregistration, manifest, verdict, output artifact, and QC/MIT/QA
hashes. `stock_etf_scorecard_verdict_v1` requires
`paper_shadow_reconciliation_hash`. `tiny_live_adr_eligibility_v1` now also
requires scorecard derivation/verdict/manifest, paper-shadow reconciliation,
DQ/statistical preregistration, and QC/MIT/QA review lineage, while remaining a
discussion-only gate that rejects tiny-live/live authorization values.

### ADR-0048 2026-06-30 Addendum F

`program_code/broker_connectors/ibkr_connector/` now exists as an inert
source-only connector skeleton outside the Bybit connector tree. It may expose
typed blocked readiness/previews and secret-free fixtures only. It imports no
IBKR SDK, performs no socket/HTTP network contact, reads no secrets, exposes no
...
| SM-03 | OMS / Execution State Machine | `rust/openclaw_engine/src/order_manager.rs`（真實 OMS 生命週期權威）| ✅ Active | Formal execution object lifecycle: pending/approved/submitted/filled/completed plus cancel/reconcile/fail states。2026-07-04 TW per FA F6 更正：舊 `oms_state_machine.py` 全 repo 不存在，功能實由 Rust `order_manager.rs` 承載；`rust/openclaw_core/src/sm/oms.rs` 為死碼（openclaw_engine 0 引用）不是實現物 |
...
|------|------|-----------|--------|-------------|
| EX-01 | Protection & Anti-Hunt | `rust/openclaw_engine/src/position_risk_evaluator.rs`、`risk_checks.rs` | ✅ Active | Hard stops, ATR dynamic distance, correlation gates。2026-07-04 TW per FA F6 更正：舊 `protective_order_manager.py`/`portfolio_risk_control.py` 全 repo 不存在，止損/風控實由 Rust 承載 |
| EX-02 | OMS & Order Lifecycle | `rust/openclaw_engine/src/order_manager.rs` | ✅ Active | 11-state order management with reconciliation gate。2026-07-04 TW per FA F6 更正：舊 `oms_state_machine.py` 不存在，同 SM-03 由 Rust `order_manager.rs` 承載 |
...
| DOC-05 | Truth Source & Ownership Matrix（真相源與所有權矩陣 V1.1）| `docs/decisions/DOC-05_OpenClaw_Bybit_Truth_Source_Ownership_Matrix_真相源与所有权矩阵_V1.1.md`（治理落地文件；write-authority 由 governance_hub.py + Rust 執行權威落實，非單一 code module）| ✅ Active | 每個核心對象的唯一真相源 / 主寫入方 / 讀取方 / 建議權 / 人工覆蓋路徑 / 禁止寫入方 / 衝突處理原則。2026-07-04 TW per R4 補回：本 row 前輪缺席 Active DOC 表（DOC-04→DOC-06 跳號），DOC-05 決策文件實存且被 DOC-06 引用，非退役 |
...
| ADR-0045 | M4 Hypothesis Discovery Governance | docs/adr/0045-m4-hypothesis-discovery-governance.md | ⬜ Reserved | Sprint 1A-ε（檔案為 Reserved placeholder；Decision/Consequences/Sign-off 待 Sprint 6+ M4 IMPL 補；2026-07-09 R4 對齊檔案下修 Active→Reserved）|
...
| AMD-2026-07-11-01 | IBKR Stock/ETF current override | docs/governance_dev/amendments/2026-07-11--AMD-2026-07-11-01-ibkr-stock-etf-full-live-capability-development.md | ✅ Accepted | Current `stock_etf_cash` policy: full live-capable implementation is allowed; default inactive, real contact/effect only after Rust validates an explicit commit/account/session/time-bound activation envelope. |
| ADR-0048 | IBKR Stock/ETF Paper + Shadow Lane | docs/adr/0048-ibkr-stock-etf-paper-shadow-lane.md | ✅ Active | Accepts `stock_etf_cash` as an isolated IBKR read-only / paper / shadow research lane under Phase 0 named contracts; Phase 0 manifest source now validates schema/status/scope, ADR/AMD/packet path authority, loopback paper API baseline, global denials, exact contract list including instrument identity, PIT universe, strategy hypothesis, risk policy, and lane-scoped IPC, and fail-closed phase unlock table. Phase 1 source foundation covers closed type/config/IPC fixture/source-only DDL, machine-checkable broker capability registry validation for the full operation matrix and Bybit/IBKR separation, `lane_scoped_ipc_v1` validation for the exact `stock_etf.*` IPC method/gate/field/typed-denial matrix plus `stock_etf_risk_policy_v1` paper gate and Bybit paper-path separation, Python no-write AST guard coverage for Stock/ETF/IBKR route/future-connector files without scanning existing Bybit modules, point-in-time instrument identity validation, PIT universe membership validation, strategy hypothesis preregistration validation, `stock_etf_risk_policy_v1` validation for dormant paper/shadow cash-only caps/universe/cost/order gates/no-contact boundaries, plus a DB evidence DDL contract for required schemas/tables/natural keys, lane/broker/live-denial constraints, paper/shadow separation, Guard A/B/C controls, and future PG dry-run/double-apply requirements without migration apply authority. Phase 2 source covers typed external-surface gate / allowlist / session attestation / redaction / rate-limit / audit / paper-attestation / Python no-write prerequisites, IPC pre-contact status visibility, immutable gate artifact validation, secret-slot/topology runtime evidence contracts, artifact rejection for missing/mismatched runtime evidence, feature-flag/secret/scoped-auth matrix validation, and paper lifecycle/event-log transition validation. Asset-lane audit event source covers immutable `audit.asset_lane_events_v1` references across gate/DQ/scorecard/release evidence, with hash-chain and redaction boundaries but no audit writer/runtime authority. Phase 3 source covers market-data provenance, accepted PIT universe and strategy hypothesis contracts plus frozen inputs, DQ/quarantine manifest, evidence-clock day checker contracts, and scorecard input validators for cash ledger / cost model / benchmark / shadow fill / storage capacity / derived-only bundle boundaries. Phase 4 GUI readiness covers a display-only console tab and fail-closed readiness endpoint, plus source validation for GET-only display, untrusted client lane state, no effect-capable surfaces, route/cache/auth partition, stale-cache cross-lane denial, and crypto Decision Lease/risk regression evidence. Disable-cleanup source covers exact kill flags, collector stop, GUI disable/hide, live-secret absence, forward-only archive/DB retention, append-only audit, Bybit-live-unchanged proof, and default rejection of contact/connector/paper-order/secret/destructive-cleanup/release/tiny-live/live authority. Phase 5 source covers release/shakedown packet validation, role signoff/hash requirements, forward-only evidence archive checks, and a default blocked template, without release/tiny-live/live authority. Tiny-live ADR eligibility source covers the discussion-only gate for a future ADR and rejects `tiny_live_authorized` / `live_authorized` decisions even with positive paper/shadow evidence. Bybit remains the only active live execution venue; IBKR contact still requires real secret/topology evidence plus immutable PASS artifact; IBKR live/tiny-live/margin/short/options/CFD/transfer remain denied. |
...
| 2026-05 | AMD / ADR governance 大量 land | AMD-2026-05-02-01 起至 AMD-2026-05-31-01（SM-02 R-04 retrofit、graduated canary / TOML SOP、dual-track→commercial-evidence-sprint chain、autonomy-with-failsafe、commercialization exchange-native-only、alpha-edge evidence governance 等）+ ADR-0021~0047（v5.8 13-module thesis Sprint 1A 系列 + Alpha-Edge governance）陸續 land；部分 amendment 當時未回填本 register（見 2026-07-09 補登）。 |
| 2026-06 | IBKR 研究 lane + cold audit 訂正 | AMD-2026-06-29-01（IBKR `stock_etf_cash` paper/shadow lane）+ ADR-0048 land；2026-06-14 全盤 cold audit / DOC governance drift 訂正（DOC-05 補回、SM-03/EX-01/DOC-01 Rust 權威 per FA F6）。 |
| 2026-07 | IBKR Phase 2 + DOC-06 規則 | AMD-2026-07-04-01（DOC-06 runtime mutation record rule RM-1..4）+ AMD-2026-07-08-01（IBKR `stock_etf_cash` Phase 2 read-only external-contact 授權）；`Last Updated` → 2026-07-08。 |
| 2026-07-09 | R4 register reconciliation | 補登 13 條漏登 amendment（AMD-2026-05-03-01 / 05-09-04 demo-promotion / 05-09-03※ strategist / 05-10-03/04/05 / 05-11-W6-1 / 05-20-01..05 chain / phys-lock draft）；§6 索引指標 `docs/README.md`→`docs/_indexes/`；10 ADR（0033/0034/0036/0038-0044）Status `Proposed-pending-commit`→`Accepted` 對齊 register Active；ADR-0045 register row `Active`→`Reserved` 對齊檔案 placeholder。amendments 資料夾 = 28 檔（ground truth）。 |
