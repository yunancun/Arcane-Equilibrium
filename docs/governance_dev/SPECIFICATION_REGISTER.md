...
| REF-21 | Full-Chain Replay Engine | docs/execution_plan/2026-05-06--ref21_full_chain_replay_engine_dev_plan_v1_2.md | 🟠 Revise / Blocked | Active V1.2 plan；provisional `/full-chain/prepare` endpoint default-OFF；R2/R3 前必過 dedicated subprocess env/auth 禁繼承、forbidden guard、write confinement、V057/V058/V059 data migrations、OOS/edge snapshot、tier promotion、maker clamp、auth/rate、Bybit data reality、applier prerequisite、GUI safety、16-principle acceptance gates；MLDE/DreamEngine 僅作 verified advisory / exploration consumer。 |
