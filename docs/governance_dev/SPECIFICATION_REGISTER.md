...
| REF-21 | Full-Chain Replay Engine | docs/execution_plan/2026-05-06--ref21_full_chain_replay_engine_dev_plan_v1_1.md | 🟠 Revise / Blocked | 8-agent audit 後的 active plan；保留 scanner→strategy→risk→execution→exit 目標，但 R2/R3 前必過 dedicated subprocess、forbidden guard、state pollution、edge snapshot、OOS、tier promotion、maker clamp、auth/rate、Bybit data reality、GUI safety 等 B-gates；MLDE/DreamEngine 僅作 verified advisory / exploration consumer，不直接改 demo/live。 |
