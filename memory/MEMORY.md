...
- [ultracode 全審弧 (07-11 修復部署+07-24 run0)](project_2026_07_11_ultracode_audit_remediation.md) — 07-11:4C/2R/8seam,9項`6b7ad5ca8`上main+引擎重部署,6/7/Q4併main(V157 pending);**07-24 run0(`wf_749b4f8c-2ea`,head=runtime=`7d78765a2`):9C/1L/3D/1R+5seam+92債,首要二項同日收口(PR#115 併fix+`S1_CLOSED` PR#117+TODO v852 PR#118);adaptive子集會漏4/9 confirmed→`adaptive_shadow`默認不可退;QC:PROFIT-1仍在+DSR缺√Var縮放=K≥2必block;正本報告+decision_view 在 PM reports 2026-07-24**;topic檔
...
- [AI/ML roadmap→AIML-V2：S1_CLOSED→S2 source chain](project_2026_07_21_aiml_s0_adoption_gate.md) — 07-22 `PROGRAM_ADOPTED`；S1_CLOSED（PR#115/#117）；**07-28 S2 七個 source predicates 全 `SOURCE_READY`**（S2.4 PR#145/#146；S2.5+S2.2B seam PR#148/#150，E2 兩輪 delta PASS；final PR#151 merge `a7c36775d` 三端同步）→ 終態 **`BLOCKED_OPERATOR_ACTION_PACKET_READY`**（packet=`S2-operator-action-packet-v1.md`，DAG S2.0→S2.4→S2.5A→S2.1→S2.5B→S2.2B，前置 S2.4-AMEND-1/2）；runtime 仍 inactive/not-found、九 authority=false；W5 receipts 現綁 `5be472193`(round7)；教訓：自報 digest≠重算/effect 後例外裸逸/ledger 無 head anchor/probe-only 鎖非互斥/lane-mixing；topic 檔
