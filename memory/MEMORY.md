...
- [L2 Mesh P1-P3b DEPLOYED+owed 五項 DONE (2026-06-10)](project_2026_06_08_l2_d3_phase1_green.md) — topic 原文保留部署/owed 歷史；**current authority correction 2026-06-12**: active L2 tail 在 `TODO.md` row `P1-L2-ADVISORY-MESH-TAILS`，`L2_TODO.md` 只是专题 ledger/reference；E2E-1 仍需 operator 明確批准一次 true model call 後復原 disabled，不得按本舊索引視為全閉。
