...
## Project context
- [框架健檢 23/23 CONFIRMED+全項優化裁決 (2026-08-01)](project_2026_08_01_framework_health_audit.md) — 主訴 session 久+用量飛耗→8 線:cache_read 10.86B/subagent output 65%/五 loop CONFIRMED;operator 裁全項+三級模型分級;四 PR merge(#165-168)+第二刀 skills 30 條正確性修正;wave2 待辦見 topic 檔
