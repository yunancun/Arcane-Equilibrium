...
REPORT_PATH = RUNTIME_BASE / "bybit_compute_governor_runtime_latest.json"
PREFIX = "bybit_compute_governor_runtime_contract"
...
def main() -> None:
    ...
    checks = [
        ...
        mkcheck("runtime_type_expected", obj.get("runtime_type") == "bybit_compute_governor_runtime", obj.get("runtime_type")),
        mkcheck("runtime_version_v1", obj.get("runtime_version") == "v1", obj.get("runtime_version")),
        mkcheck("stage_h4c", obj.get("stage") == "H4-C", obj.get("stage")),
        ...
        mkcheck("allow_progress_bool", isinstance(obj.get("allow_progress_to_h4d_final_audit"), bool), obj.get("allow_progress_to_h4d_final_audit")),
    ]
    ...
    report = {
        "report_type": "bybit_compute_governor_runtime_contract_check",
        "report_version": "v1",
        "ts_ms": now_ms,
