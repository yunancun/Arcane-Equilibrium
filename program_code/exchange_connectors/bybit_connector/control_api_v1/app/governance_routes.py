...
# ── 6-01~03: Strategy Promotion Pipeline Endpoints ──
# 6-01~03：策略漸進放權管線端點

import threading as _threading
_promotion_gate_lock = _threading.Lock()
...
def get_promotion_pipeline_status(
    ...
    try:
        if strategy_name:
            ...
            # 用原始名稱做內部查詢；html.escape 僅用於日誌/回應顯示
...
def promote_strategy(
    ...
    try:
        ...
        # Raw names for internal lookup; JSON API — no HTML rendering risk
        # 原始名稱做內部查詢；JSON API 無 HTML 渲染風險
