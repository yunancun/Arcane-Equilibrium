...
(function() {
  if (!document.getElementById('oc-disabled-card-css')) {
    ...
    s.textContent = '.oc-disabled-card{position:relative;background:rgba(var(--ov-panel-b-rgb),0.7);border:1px dashed var(--border-subtle);border-radius:var(--r-2);padding:18px 20px 22px;margin-bottom:14px;opacity:0.78;cursor:not-allowed}.oc-disabled-card:focus{outline:2px solid var(--accent);outline-offset:2px}.oc-disabled-card:focus:not(:focus-visible){outline:none}.oc-disabled-card-header{display:flex;align-items:flex-start;gap:10px;margin-bottom:8px}.oc-disabled-card-icon{font-size:22px;line-height:1;flex-shrink:0;color:var(--text-secondary)}.oc-disabled-card-title{flex:1;min-width:0}.oc-disabled-card-title h3{font-size:14px;font-weight:600;margin:0 0 2px;color:var(--text-primary)}.oc-disabled-card-title .en{color:var(--text-secondary);font-size:12px;font-weight:400;margin-top:2px}.oc-disabled-card-phase{flex-shrink:0;font-size:10px;font-weight:700;padding:3px 9px;border-radius:999px;background:rgba(210,153,34,0.15);color:var(--warn);border:1px solid rgba(210,153,34,0.4);letter-spacing:0.4px}.oc-disabled-card-phase.phase-p3{background:rgba(var(--ov-accent-rgb),0.15);color:var(--text-secondary);border-color:rgba(var(--ov-accent-rgb),0.4)}.oc-disabled-card-phase.phase-p6{background:rgba(248,81,73,0.12);color:var(--neg);border-color:rgba(248,81,73,0.35)}.oc-disabled-card-banner{font-size:12px;color:var(--text-secondary);line-height:1.6;padding:8px 12px;background:rgba(var(--ov-panel-rgb),0.55);border-left:3px solid var(--text-secondary);border-radius:var(--r-1);margin-top:6px}.oc-disabled-card-banner .zh{display:block;color:var(--text-primary)}.oc-disabled-card-banner .en{display:block;color:var(--text-secondary);font-size:11px;margin-top:2px}.oc-disabled-card-metrics{display:grid;gap:8px;margin-top:14px;grid-template-columns:repeat(auto-fill,minmax(150px,1fr))}.oc-disabled-card-metric{background:rgba(var(--ov-panel-rgb),0.4);border:1px dashed var(--border-subtle);border-radius:var(--r-1);padding:8px 10px;min-height:46px}.oc-disabled-card-metric .label{font-size:9px;color:var(--text-secondary);text-transform:uppercase;letter-spacing:0.4px}.oc-disabled-card-metric .val{font-size:13px;color:var(--text-secondary);font-weight:500;margin-top:4px;opacity:0.7}@media(max-width:700px){.oc-disabled-card{padding:14px 14px 16px}.oc-disabled-card-metrics{grid-template-columns:1fr 1fr}}';
