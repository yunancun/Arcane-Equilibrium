...
(function _ocHandoffHelperModule() {
  ...
  function injectCSS() {
    ...
    s.textContent = [
      // Card / form layout
      ".oc-handoff-card{background:rgba(var(--ov-panel-b-rgb),0.7);border:1px solid var(--border-subtle);",
        "border-radius:var(--r-2);padding:18px 20px 22px;margin-bottom:14px}",
      ...
      ".oc-handoff-phase-chip{flex-shrink:0;font-size:10px;font-weight:700;",
        ...
        "color:var(--neg);border:1px solid rgba(248,81,73,0.35);letter-spacing:0.4px}",
      ".oc-handoff-empty-notice{font-size:12px;color:var(--text-secondary);line-height:1.6;",
        "padding:10px 12px;background:rgba(var(--ov-panel-rgb),0.55);border-left:3px solid var(--warn);",
        "border-radius:var(--r-1);margin:8px 0}",
      ".oc-handoff-grid{display:grid;gap:8px;margin-top:10px;",
        "grid-template-columns:repeat(auto-fill,minmax(180px,1fr))}",
      ".oc-handoff-field{background:rgba(var(--ov-panel-rgb),0.4);border:1px solid var(--border-subtle);",
        "border-radius:var(--r-1);padding:8px 10px;min-height:46px}",
      ".oc-handoff-field-label{font-size:9px;color:var(--text-secondary);",
        "text-transform:uppercase;letter-spacing:0.4px}",
      ".oc-handoff-field-value{font-size:13px;color:var(--text-primary);font-weight:500;",
        "margin-top:4px;word-break:break-all}",
      // Notes textarea
      ".oc-handoff-notes-row{margin-top:14px}",
      ".oc-handoff-notes-row textarea{width:100%;font-family:inherit;font-size:12px;",
        "padding:8px 10px;background:rgba(var(--ov-panel-rgb),0.55);border:1px solid var(--border-subtle);",
        "border-radius:var(--r-1);color:var(--text-primary);resize:vertical;margin-top:4px}",
      ...
      ".oc-handoff-cooldown-msg{font-size:11px;color:var(--warn);font-family:monospace}",
      // Dual-actor banner
      ".oc-handoff-dual-banner{display:flex;align-items:center;gap:8px;flex-wrap:wrap;",
        "padding:8px 12px;border-radius:var(--r-1);font-size:12px;line-height:1.5;margin:6px 0 10px}",
      ".oc-handoff-dual-banner.same-actor{background:rgba(210,153,34,0.1);",
        "color:var(--warn);border:1px solid rgba(210,153,34,0.4)}",
      ".oc-handoff-dual-banner.ok{background:rgba(46,160,67,0.1);",
        "color:var(--pos);border:1px solid rgba(46,160,67,0.4)}",
      ".oc-handoff-dual-banner.freeze{background:rgba(248,81,73,0.12);",
        "color:var(--neg);border:1px solid rgba(248,81,73,0.5);font-weight:600}",
      ".oc-handoff-dual-banner.pending{background:rgba(var(--ov-accent-rgb),0.1);",
        "color:var(--text-secondary);border:1px dashed rgba(var(--ov-accent-rgb),0.3)}",
      ...
      // Recent footer
      ".oc-handoff-recent{margin-top:18px;border-top:1px dashed var(--border-subtle);padding-top:12px}",
      ".oc-handoff-recent-header{font-size:11px;color:var(--text-secondary);",
      ...
      ".oc-handoff-recent-row{display:grid;",
        ...
        "padding:6px 8px;background:rgba(var(--ov-panel-rgb),0.4);border-radius:var(--r-1);",
        "font-size:11px;align-items:center}",
      ".oc-handoff-recent-row .actor{font-family:monospace;color:var(--text-primary)}",
      ".oc-handoff-recent-row .ts{color:var(--text-secondary)}",
      ".oc-handoff-recent-row .result{font-weight:600}",
      ".oc-handoff-recent-row .result-ok{color:var(--pos)}",
      ".oc-handoff-recent-row .result-fail{color:var(--neg)}",
      ".oc-handoff-recent-row .result-rej{color:var(--warn)}",
      ".oc-handoff-recent-row .result-cached{color:var(--text-secondary)}",
      ...
      ".oc-handoff-recent-empty{font-size:12px;color:var(--text-secondary);",
        "padding:14px;text-align:center;line-height:1.6}",
      ".oc-handoff-recent-loading{font-size:12px;color:var(--text-secondary);",
        "padding:14px;text-align:center;font-style:italic}",
      ".oc-handoff-recent-todo{font-size:10px;color:var(--text-secondary);",
      ...
      ".oc-handoff-modal{background:var(--bg-surface);border:1px solid var(--border-strong);",
        "border-radius:var(--r-3);width:min(560px,100%);max-height:90vh;overflow-y:auto;",
        "box-shadow:0 20px 50px rgba(0,0,0,0.5);outline:none}",
      ".oc-handoff-modal-head{padding:16px 20px;border-bottom:1px solid var(--border-subtle);",
        "display:flex;justify-content:space-between;align-items:center}",
      ".oc-handoff-modal-head h3{margin:0;font-size:14px;font-weight:600;color:var(--text-primary)}",
      ".oc-handoff-modal-close{background:none;border:none;color:var(--text-secondary);",
        "font-size:18px;cursor:pointer;padding:4px 8px;line-height:1;min-height:32px;min-width:32px}",
      ".oc-handoff-modal-close:hover{color:var(--text-primary)}",
      ".oc-handoff-modal-close:focus{outline:2px solid var(--accent);outline-offset:1px;border-radius:var(--r-1)}",
      ".oc-handoff-modal-body{padding:16px 20px}",
      ".oc-handoff-modal-section-title{font-size:11px;color:var(--text-secondary);",
        "text-transform:uppercase;letter-spacing:0.4px;margin-bottom:6px}",
      ".oc-handoff-modal-summary{display:flex;flex-direction:column;gap:4px;",
        "background:rgba(var(--ov-panel-rgb),0.5);border-radius:var(--r-1);padding:8px 10px;",
        "border:1px solid var(--border-subtle)}",
      ".oc-handoff-modal-row{display:flex;justify-content:space-between;gap:12px;",
        "font-size:12px;padding:3px 0;border-bottom:1px dashed var(--border-subtle)}",
      ".oc-handoff-modal-row:last-child{border-bottom:none}",
      ".oc-handoff-modal-row .lbl{color:var(--text-secondary);flex-shrink:0}",
      ".oc-handoff-modal-row .val{color:var(--text-primary);font-family:monospace;font-size:11px;",
        "word-break:break-all;text-align:right}",
      ".oc-handoff-modal-hint{font-size:11px;color:var(--text-secondary);line-height:1.6;",
        "margin-bottom:4px}",
      ".oc-handoff-modal-hint .zh{color:var(--text-primary)}",
      ".oc-handoff-modal-hint .en{color:var(--text-secondary);font-size:10px}",
      ".oc-handoff-modal-template{display:block;margin-top:4px;font-size:11px;",
        "padding:6px 8px;background:rgba(var(--ov-accent-rgb),0.08);color:var(--text-secondary);",
        "border:1px solid rgba(var(--ov-accent-rgb),0.25);border-radius:var(--r-1);word-break:break-all}",
      ".oc-handoff-modal-input{width:100%;font-family:monospace;font-size:13px;",
        "padding:10px 12px;background:rgba(var(--ov-panel-rgb),0.7);border:2px solid var(--border-subtle);",
        "border-radius:var(--r-1);color:var(--text-primary);margin-top:6px;letter-spacing:0.5px}",
      ".oc-handoff-modal-input:focus{outline:none;border-color:var(--text-secondary)}",
      ".oc-handoff-modal-input[aria-invalid='false']{border-color:var(--pos)}",
      ".oc-handoff-modal-meta{display:flex;align-items:center;gap:8px;",
        "margin-top:10px;font-size:11px;color:var(--text-secondary);flex-wrap:wrap}",
      ".oc-handoff-modal-meta .lbl{font-weight:600}",
      ".oc-handoff-modal-meta code{font-family:monospace;font-size:10px;",
        "padding:2px 6px;background:rgba(var(--ov-panel-rgb),0.6);border:1px solid var(--border-subtle);",
        "border-radius:var(--r-1);color:var(--text-primary);word-break:break-all}",
      ".oc-handoff-modal-warning{margin-top:12px;padding:8px 12px;",
        "background:rgba(210,153,34,0.08);color:var(--warn);font-size:11px;",
        "border:1px solid rgba(210,153,34,0.3);border-radius:var(--r-1);line-height:1.5}",
      ...
      ".oc-handoff-modal-foot{padding:12px 20px;border-top:1px solid var(--border-subtle);",
      ...
      "@media(max-width:700px){",
        ...
        ".oc-handoff-modal{max-height:95vh;border-radius:var(--r-2)}",
