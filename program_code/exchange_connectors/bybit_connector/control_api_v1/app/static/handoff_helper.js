  ...
  function injectCSS() {
    ...
    s.textContent = [
      ...
      ".oc-handoff-notes-row textarea{width:100%;font-family:inherit;font-size:12px;",
        ...
        "border-radius:var(--r-1);color:var(--text);resize:vertical;margin-top:4px}",
      ...
      ".oc-handoff-modal-input{width:100%;font-family:monospace;font-size:13px;",
        ...
        "border-radius:var(--r-1);color:var(--text);margin-top:6px;letter-spacing:0.5px}",
      ...
      ".oc-handoff-modal-meta code{font-family:monospace;font-size:10px;",
        ...
        "border-radius:var(--r-1);color:var(--text);word-break:break-all}",
