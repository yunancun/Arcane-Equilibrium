...
(function _ocHandoffHelperModule() {
  ...
  function injectCSS() {
    ...
    s.textContent = [
      // Card / form layout
      ".oc-handoff-card{background:rgba(22,27,34,0.7);border:1px solid var(--border-subtle);",
      ...
      ".oc-handoff-empty-notice{font-size:12px;color:var(--text-secondary);line-height:1.6;",
        "padding:10px 12px;background:rgba(13,17,23,0.55);border-left:3px solid var(--warn);",
        "border-radius:var(--r-1);margin:8px 0}",
      ".oc-handoff-grid{display:grid;gap:8px;margin-top:10px;",
        "grid-template-columns:repeat(auto-fill,minmax(180px,1fr))}",
      ".oc-handoff-field{background:rgba(13,17,23,0.4);border:1px solid var(--border-subtle);",
      ...
      ".oc-handoff-notes-row textarea{width:100%;font-family:inherit;font-size:12px;",
        "padding:8px 10px;background:rgba(13,17,23,0.55);border:1px solid var(--border-subtle);",
      ...
      ".oc-handoff-dual-banner.pending{background:rgba(56,139,253,0.1);",
        "color:var(--text-secondary);border:1px dashed rgba(56,139,253,0.3)}",
      ...
      ".oc-handoff-recent-row{display:grid;",
        ...
        "padding:6px 8px;background:rgba(13,17,23,0.4);border-radius:var(--r-1);",
      ...
      ".oc-handoff-modal-summary{display:flex;flex-direction:column;gap:4px;",
        "background:rgba(13,17,23,0.5);border-radius:var(--r-1);padding:8px 10px;",
      ...
      ".oc-handoff-modal-template{display:block;margin-top:4px;font-size:11px;",
        "padding:6px 8px;background:rgba(56,139,253,0.08);color:var(--text-secondary);",
        "border:1px solid rgba(56,139,253,0.25);border-radius:var(--r-1);word-break:break-all}",
      ".oc-handoff-modal-input{width:100%;font-family:monospace;font-size:13px;",
        "padding:10px 12px;background:rgba(13,17,23,0.7);border:2px solid var(--border-subtle);",
      ...
      ".oc-handoff-modal-meta code{font-family:monospace;font-size:10px;",
        "padding:2px 6px;background:rgba(13,17,23,0.6);border:1px solid var(--border-subtle);",
