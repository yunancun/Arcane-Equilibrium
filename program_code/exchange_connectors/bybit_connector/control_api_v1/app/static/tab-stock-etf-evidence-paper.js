...
(function () {
  ...
  function renderEvidenceStatus(data) {
    ...
    document.getElementById('se-evidence-body').innerHTML = [
      ...
      kvRow('evidence_clock.collector_run_contract_id', textChip(clock.collector_run_contract_id || '-')),
      kvRow('evidence_clock.collector_run_hash_present', boolChip(clock.collector_run_contract_hash_present, false)),
      kvRow('evidence_clock.dq_manifest_contract_id', textChip(clock.dq_manifest_contract_id || '-')),
      kvRow('evidence_clock.dq_manifest_hash_present', boolChip(clock.dq_manifest_contract_hash_present, false)),
      kvRow('evidence_clock.source_artifact_hash_present', boolChip(clock.source_artifact_hash_present, false)),
      kvRow('evidence_clock.market_data_provenance_hash_present', boolChip(clock.market_data_provenance_contract_hash_present, false)),
      kvRow('evidence_clock.scorecard_input_hash_present', boolChip(clock.scorecard_input_bundle_hash_present, false)),
