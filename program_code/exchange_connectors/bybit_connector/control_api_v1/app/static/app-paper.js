...
(function _wireReplaySubtabNamespace() {
  ...
  function _injectReplayReadyCss() {
    ...
    s.textContent = ''
      ...
      + 'border-left:3px solid var(--blue);border-radius:var(--r-1);margin:8px 0 14px}'
      ...
      + 'flex-wrap:wrap;border:1px dashed var(--border);border-radius:var(--r-1);'
      ...
      + 'border:1px solid var(--border);border-radius:var(--r-1);padding:7px 9px;'
