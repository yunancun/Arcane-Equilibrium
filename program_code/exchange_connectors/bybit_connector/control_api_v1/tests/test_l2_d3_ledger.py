...
class TestRedactor:
    ...
    def test_dsn_credential_redacted_scheme_kept(self):
        ...
        r = R.redact("postgresql://redacted@db/trading_ai")
    ...
    def test_idempotent(self):
        ...
        once = R.redact("api_key=ZZZZZZZZZZZZZZZZ1234 and postgres://redacted@h/db").text
    ...
    def test_jsonb_recursive(self):
        obj = {
            ...
            "nested": {"dsn": "postgres://redacted@h/db"},
...
FAKE_DSN = "postgresql://redacted@trade-core:5432/trading_ai"
