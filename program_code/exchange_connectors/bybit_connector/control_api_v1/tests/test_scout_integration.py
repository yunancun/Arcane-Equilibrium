...
# DEAD-PY-2: PipelineBridge import removed
...
# mock_components + pipeline_bridge fixtures deleted (DEAD-PY-2)
...
# Test Class 3 (TestPipelineBridgeScoutIntegration) deleted (DEAD-PY-2)
