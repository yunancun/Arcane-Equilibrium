...
MODULE_NOTE (中文):
  驗證 Sprint A 只讀 allowlist：只暴露 /api/v1/openclaw/status 與
  /api/v1/openclaw/self-state，PG / request context 缺失時回 degraded
...
def _pg_returns(
    *,
    ...
    cursor = _FakeCursor(tables_present=tables_present, counts=counts)
