...
# SignalEngine extracted to signal_engine.py (FIX-08 file size).
# Re-export for backward compatibility / 向后兼容重导出。
from .signal_engine import SignalCallback, SignalEngine  # noqa: F401
