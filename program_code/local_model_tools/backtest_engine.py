...
# Types extracted to backtest_types.py (FIX-08 file size).
# 类型提取至 backtest_types.py（FIX-08 文件大小）。
from .backtest_types import (  # noqa: F401 — re-export for backward compat
...
# BacktestConfig, BacktestTrade, BacktestResult: see backtest_types.py
