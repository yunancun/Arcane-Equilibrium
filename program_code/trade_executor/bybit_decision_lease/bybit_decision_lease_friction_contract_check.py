...
TARGET = BASE / "bybit_decision_lease_friction_final_audit_latest.json"
STEM = "bybit_decision_lease_friction_contract"
...
def main() -> None:
    ...
    add("audit_type_expected", obj.get("audit_type") == "bybit_decision_lease_friction_final_audit", obj.get("audit_type"))
    add("audit_version_v1", obj.get("audit_version") == "v1", obj.get("audit_version"))
    add("stage_i5c", obj.get("stage") == "I5-C", obj.get("stage"))
