"""Program-adoption(S0.3)受理路徑測試(自 test_aiml_gate_receipt_validator.py 拆出)。

2000 行治理拆分:test 函式名與本體逐字保留,僅 import/fixture 接線調整;共用 builders 在
aiml_gate_receipt_validator_testkit(非收集模組)。
"""
