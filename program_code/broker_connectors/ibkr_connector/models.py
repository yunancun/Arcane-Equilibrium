...
class IbkrSessionAttestationPreview:
    ...
    host: str = ""
    port: int = 0
    process_identity_present: bool = False
    gateway_mode: str = "unknown"
    secret_slot_fingerprint_present: bool = False
    secret_slot_mode: str = "unknown"
    secret_world_readable: bool = False
    live_secret_absent_or_empty: bool = False
    env_var_credential_fallback_used: bool = False
