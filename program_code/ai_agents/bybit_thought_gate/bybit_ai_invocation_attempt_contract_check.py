...
INVOCATION_PATH = get_thought_gate_runtime_dir() / "bybit_ai_invocation_attempt_latest.json"
OUTPUT_LATEST_PATH = get_thought_gate_runtime_dir() / "bybit_ai_invocation_attempt_contract_latest.json"
