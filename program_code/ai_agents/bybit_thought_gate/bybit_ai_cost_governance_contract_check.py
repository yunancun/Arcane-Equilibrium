...
REPORT_PATH = Path("/home/ncyu/srv/docker_projects/trading_services/runtime/bybit/thought_gate/bybit_ai_cost_governance_final_audit_latest.json")
PREFIX = "bybit_ai_cost_governance_contract"
...
def main() -> None:
    ...
    checks = [
        ...
        mkcheck("audit_type_expected", obj.get("audit_type") == "bybit_ai_cost_governance_final_audit", obj.get("audit_type")),
    ...
    report = {
        "report_type": "bybit_ai_cost_governance_contract_check",
        "report_version": "v1",
        "ts_ms": now_ms,
