...
REPORT_PATH = RUNTIME_BASE / "bybit_model_router_final_audit_latest.json"
PREFIX = "bybit_model_router_contract"
...
def main() -> None:
    ...
    checks = [
        ...
        mkcheck("audit_type_expected", obj.get("audit_type") == "bybit_model_router_final_audit", obj.get("audit_type")),
    ...
    report = {
        "report_type": "bybit_model_router_contract_check",
        "report_version": "v1",
        "ts_ms": now_ms,
