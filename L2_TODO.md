...
| P4 | online-FDR research loop（α-wealth + V132 sealer + novelty + N_eff + Q3 cascade），tier-gated L3+ | 🔄 設計 DONE `b40b9481`；**MIT M1+M2 ratified ✅ 2026-06-10**（+1 binding 條件 #3） | 殘：QC sign-off + operator V137 確認 → E1；sealed-holdout 證實（P4→P5） |
