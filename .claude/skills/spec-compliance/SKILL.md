...
5. **產出 fragment** — 回 immutable `role_fragment_v1` with `payload_kind=finding_fragment_v1`：審計範圍/基準、逐 DOC 狀態、BLOCKER、證據 ref、Approve|Conditional|Reject、next owner/action；不自動寫 role report/memory。
