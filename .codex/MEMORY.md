...
- runtime apply note: the operator-requested post-sync rebuild loaded the MA R:R
  ...
  blocklist. The later bb_breakout 5m checkpoint is source/test only until the
  next explicitly authorized rebuild/restart.
