...
- TODO v20 is the active dispatch queue as of 2026-05-14. v20 is a lightweight maintenance sync over v19: it makes the 2026-05-13 runtime/attribution recheck explicit, closes `P0-MIT-LABEL-CLOSE-TAG-1` only within its post-M3 writer scope, keeps `P0-EDGE-1` active because net after fee remains negative / `[40]` is LOW_SAMPLE, corrects W-AUDIT-4b to 3 retained INSERT tables + 2 retained views + 1 dropped/no-DDL target, records the M0 Follow-Up freeze for hot Rust WIP, and adds `P1-MIT-REJECTED-GOVERNANCE-LABEL-VOLUME`. Do not start proposal/mobile/second-GUI/Stage 3/4/true-live work from stale AgentTodo/TODO text.
