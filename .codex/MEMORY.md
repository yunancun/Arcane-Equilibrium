...
- Boundary after W-B: engine/API were rebuilt/restarted with `--keep-auth` only for shadow Agent Spine mode. No live auth mutation, strategy/risk config change, scanner authority change, executor shadow authority, Stage 2 approval, or Decision Lease flag flip was performed.
