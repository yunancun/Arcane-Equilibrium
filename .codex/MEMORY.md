...
- The 2026-05-02 source/runtime sync and `[40]`/`[42]`/`[42b]` FAIL notes are historical; current active state is the 2026-05-09 W-AUDIT-1 / TODO v14 state above. Do not use the older LG5-W3-FUP queue as current dispatch order.
- Current runtime passive healthcheck is WARN, not FAIL. Remaining active edge/observation risk is tracked by TODO v14 W-C/W-AUDIT/P0/P1 rows plus `[33]`, `[38]`, `[40]`, `[41]`, `[42b/c]`, `[45]`, and `[51]` watch conditions.
