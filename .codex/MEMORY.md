...
- Current P1/W-B order: `P1-FAKE-1`, `P1-OPENCLAW-3`, `P1-OPENCLAW-6/7`, and source-level `P1-AGENT-OBS-1` are closed. Continue W-B runtime decision-spine lineage source/test work, then the `[14]`/`[37]`/`[40]`/`[45]` WARN cluster and sample-maturity items.
