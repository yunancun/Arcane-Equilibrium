...
- TODO v13 is the active dispatch queue as of 2026-05-07. It supersedes TODO v12's history-ledger layout and archives stale/closed context at `docs/archive/2026-05-07--todo_v12_agent_openclaw_replan_archive.md`. Current order: P1-FAKE-1 runtime smoke -> runtime decision-spine lineage -> new MAG-082 Stage 2 evidence -> MAG-083/MAG-084 -> OpenClaw read-only brief/diagnostics/escalations. Do not start proposal/mobile/second-GUI work from stale AgentTodo/TODO text.
