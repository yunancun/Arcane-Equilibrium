...
`stock_etf_phase3_evidence_contracts.toml` records the default-blocked market-data provenance, collector-run, DQ manifest, frozen-input, and evidence-clock checker shape. It requires named contract fields and checker-side side-effect denials for the collector, DQ manifest, and evidence-clock day shapes and does not start a collector, market-data ingestion, a DQ writer, or the evidence clock.
