...
> 截至 2026-04-05：4185+ tests（Py 3348 + Rs 837）· **Phase 1+2+3a 代碼完成** · sqlx 0.8 · 14 PG tables · PSI+ADWIN · ONNX+Scorer+Kelly · ml_training/ 6 模組 · 4 策略 StrategyParams · 下一步：Phase 3b → 讀 TODO.md。
