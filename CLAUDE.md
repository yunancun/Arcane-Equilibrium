...
> 截至 2026-04-05：1927 tests（Py 1075 + Rs 852）· **EXT-1 Exchange-as-Truth 實現完成** · TradingMode enum (PaperOnly/Exchange) · on_tick 雙模式分叉 · PendingOrder 追蹤 + fill 確認 · DCP/超時處理 · Demo=Live 統一路徑（改一行 config）· 下一步：讀 TODO.md。
