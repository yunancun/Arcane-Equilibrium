...
**Next decisions**：Continue post-cutoff edge observation from scanner/five-strategy deploys. Latest manual wrapper at 2026-05-01 22:02 CEST: `[33]` 7d maker_like 27.2% / fee_drop 22.0%; `[38]` lifetime_ratio 0.47 WARN (demo p50 7.9min vs live_demo 3.7min); `[40]` 24h rows=40 avg_net -19.90bps; `[41]` gates fired but labels insufficient; `[11]` is WARN not FAIL because the 2d rolling replay shrank as old exits aged out; `[27]` only FAILs when approved verdicts exist with zero persisted intents, while current rejected-only risk/cost-gate state remains WARN (`verdicts_30m=22`, `approved_verdicts_30m=0`). G2-02 ma_crossover dual-track around 2026-05-03; P0-2 + G2-01 PostOnly acceptance around 2026-05-07/08; P0-3 edge decision around 2026-05-15. Next active TODO candidates after Rank 4-7 are Rank 8 G8-05, Rank 10 LG-5, or a separately approved Rank 9 HTTPS deploy.
