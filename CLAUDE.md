...
> 截至 2026-04-10：tests engine lib **872** / core **365** / integration **11** / Python **2372** passed **1 pre-existing fail** · **Python OMS 刪除 ✅**（oms_state_machine.py 移除，Rust event_consumer → trading.orders + order_state_changes + risk_verdicts DB 寫入，commit 4cab87c） · **Phase 6 Reconciler 自動降級 ✅**（6-RC-1~5,7,8,9,10：漂移→escalation→hybrid 恢復，CB+CloseAll，+27 tests，7 e2e 場景） · **DEAD-PY-2 ✅** · **Signal Diamond Phase 1-4 ✅ + Fix Round ✅** · **Live/Demo 平倉按鈕 ✅** · **SM-1 live 授權統一 ✅** · **Live GUI P0~P6 ✅** · **Live 縮倉監控 ✅** · **Live_Ready ✅** · **SEC-05 XSS ✅** · **A2 NewsPipeline ✅** · **DEAD-PY-1 ✅** · **1C-4 ✅** · PH5-VERIFY-1 觀察期進行中 · **Live 唯一前置**：`settings/secret_files/bybit/live/` API key 填入。
