...
**Next decisions**：Continue post-cutoff edge observation from scanner/five-strategy deploys. Latest manual wrapper at 2026-05-01 22:51 CEST: `[22]` WARN maker no-fill context; `[16]` transient strategist-cycle WARN; `[33]` 7d maker_like 27.2% / fee_drop 22.0%; `[38]` lifetime_ratio 0.41 WARN (demo p50 7.9min vs live_demo 3.2min); `[40]` 24h rows=39 avg_net -17.97bps; `[41]` gates fired but labels insufficient; `[11]` is WARN not FAIL because the 2d rolling replay shrank as old exits aged out; `[27]` remains WARN for rejected-only risk/cost-gate state (`verdicts_30m=5`, `approved_verdicts_30m=0`). G2-02 ma_crossover dual-track around 2026-05-03; P0-2 + G2-01 PostOnly acceptance around 2026-05-07/08; P0-3 edge decision around 2026-05-15. Rank 9 HTTPS deploy still needs explicit runtime/deploy approval; next safe non-deploy candidates are P03-PREP-1, DOC-1, TEST-1, PRE-LIVE-1, or the remaining PRE-LIVE-3 trend charts + live readiness checklist.
