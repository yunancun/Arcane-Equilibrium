...
| **G3-08-PHASE-3-H2-H4-H5** | Phase 3 接 H2 budget + H4 validator + H5 cost_logging (per PA design §10.2 + §11.1)；3.5d wall-clock 全鏈；解阻 G3-09 cost_edge_ratio (P3) | G3-08-PHASE-2-H1-H3 ✅ | 🟠P1 | E1 ~3.5d wall-clock 全鏈 |
