...
| `P1-FUNDING-ARB-DEPRECATION-CASCADE` | 2 | 🟡 **PA SPEC LAND + TW Phase 2 IMPL DONE 2026-05-26** — PA Phase 1 spec land `docs/execution_plan/specs/2026-05-26--funding-arb-deprecation-cascade.md`；TW Phase 2 AMD-2026-05-26-01 draft land + 5 primary cascade target merged (README / SPECIFICATION_REGISTER / ADR-0018 升格 Retired / KNOWN_ISSUES line 480 / execution-plan-v5.8) + 3 TOML 註釋 + 4 ADR cross-ref (0021/0025/0038/0039) + 3 execution_plan dispatch packet + 6 SQL migration header + TODO §1+§6 標 IMPL DONE；commit `a19797d` 已 land base_ratio 0.4→0.25 + funding_arb 3% override；**PENDING**: PM operator confirm AMD-2026-05-26-01 + R4 cross-ref grep audit + E1 D+7 `#[deprecated]` IMPL + MIT D+30 PG retention + QC D+30 observation；Owner: PA ✅ → TW ✅ → PM / R4 / E1 / MIT / QC；ref §9 Workflow F + AMD-2026-05-26-01 §11 cascade checklist |
...
- **2026-05-26 OPS-3 5/5 operator confirm sequential closure + Workflow F Phase 1+2 partial**：
  ...
  - **Workflow F Phase 2 R4 Pass A** ✅ APPROVE-WITH-DRIFT (6 drift items vs PA spec §4.1 underspec: Rust 60 vs 5-8 / SQL 7 vs 6 / helper 16 vs 3 / EA-3 hotfix 33 hits / W-AUDIT-8B / SPEC-REG)；`srv/docs/CCAgentWorkSpace/R4/workspace/reports/2026-05-26--workflow-f-cross-ref-audit.md`
  - **Workflow F Phase 2 TW** in-flight (AMD-2026-05-26-01 draft + 5 cascade target)；TW 完工後 → R4 Pass B trigger
  ...
  - **3 端 git sync** ✅ Mac / origin / trade-core HEAD `6a20b9ea`
