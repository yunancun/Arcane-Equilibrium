...
| `P2-AUDIT-QC-STAND-ALONE` | QC stand-alone fixes（verdict 已由 AMD-2026-05-09-02 選定）| DONE: (1) funding_arb schema 4 TOML 完全清除 source/test; (2) Kelly tier 8/6/4 → RiskConfig.kelly.{young,mature,established}_fraction source/test; (3) bb_breakout cooldown 600k vs 300k source/test 統一；(4) DSR/PBO production caller 加進 promotion_pipeline.py demo gate source/test。Remaining: (5) CLAUDE.md §三 -26.44 加掛 healthcheck id 0.5h。 |
