...
| `P1-SANDBOX-SQLX-METADATA-ALIGNMENT` | – | ✅ **CLOSED 2026-05-22 by PM 主會話** — sandbox `_sqlx_migrations` 4 row INSERT 完成（V103/V106/V107/V112 含真實 sha384 checksum；sha384 對齊 Mac+Linux file content）；sandbox MAX 96→112 / COUNT 93→97；下次 sandbox engine restart with `AUTO_MIGRATE=1` 對 V103-V112 = idempotent skip + Guard A 反向 forbidden column 仍可 fire（健康設計）；ref decision_2_pg_checksum_alignment_runbook.md Step 3；2026-05-24 audit supersedes old trading_ai MAX=96 note: main PG current landed set now max=112 / count=102, while V099/V104/V105/V108-V116 remain future/design SQL work. |
