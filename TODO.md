...
| 11 | `W-AUDIT-4` ML 基座 + dead schema (mount W-F-1) | E1×6 並行 + MIT + E2 + E4 | ACTIVE 2026-05-09 (~30h, 3 sessions, after W-AUDIT-1) | V073 edge snapshot cycle wrapper/contract, V075 corrected retention/compression, V076 Guard A retrofit, and V077 F-29 archive CHECK source/test added. None DB-applied; cron not installed. Remaining: V068-V072/V074 source set, F-08 ML cron, F-09 FUP-2 deploy. Source work may proceed; DB apply/deploy remains separate authorization. |
...
| `P1-AUDIT-ML-4` | 3 | W-AUDIT-4 ML 基座 + dead schema (mounts W-F-1) | ACTIVE: V073 source/test adds a V059 edge snapshot contract guard and a cron wrapper around `ref21_backfill_v058_v059.py --skip-instruments --skip-freeze-log --apply`; cron is not installed. V075 source/test corrects the "9 table retention" plan to 5 hypertables + 2 plain tables + 2 views. V076 Guard A retrofit and V077 F-29 bounded archive CHECK also source/test added. None DB-applied. Remaining: V068-V071 drop/archive dead schema + V072 feature_baselines writer contract resolution + V074 decision_outcomes live backfill + F-08 5 ML cron + F-09 FUP-2 deploy. Heavy parallel; 3 sessions; depends on W-AUDIT-1. |
