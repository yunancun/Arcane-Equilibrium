...
- **Current Wave**：Sprint 1A-ε ✅ DONE (R4 5 CRITICAL + 4 HIGH patches applied / dup dedup 3 archived / README index 22 entries / A3 spec transcribed)；**Sprint 1A-δ-IMPL ✅ DONE 2026-05-21**（M5/M12/M13 Rust trait stubs + 6 Rust 檔 + +25 cargo test PASS；M5 refactor 對齊 ADR-0035 Decision 1）；Sprint 1A-ζ READY-TO-DISPATCH (W8.5-10 IMPL Prototype Spike；operator Q1-Q5 signed；Q4a override Track C M11 Python skeleton 含)；剩 operator-bound: M13/V116 dup 仲裁 + M4 ADR-0045 reserved confirm
