...
| `AEG-S3-CANDIDATE-DIRECT-ROWS` | 1 | 🟡 PM-local infra DONE / funding_revive+oi_delta PBO DONE / promotion thresholds FAIL | 2026-06-11 已新增 artifact-only `research/aeg_s3_candidate_rows/`、`research/aeg_s3_panel_export/`、`research/aeg_s3_listing_fade/`、`research/aeg_s3_oi_delta/`、`research/aeg_s3_funding_revive/`；Linux read-only 真跑完成：export `aeg_s3_v125_panel_20260611T200033Z`（V125 run `18b3c2f8…` + V127 labels；OI panel 5,920 rows / funding panel 19,536 rows，date span 2025-08-10→2026-06-01；更早歷史因缺 V127 regime fail-closed）。2026-06-12 funding_revive PBO grid support 三端 sync `03b308c7`，OI delta PBO grid support 三端 sync `5a0f9ab3`；Mac focused regression 最新 = **83 passed** + compileall OK + static forbidden-route search無命中。funding_revive true run `aeg_s3_funding_revive_v125_20260611T200033Z_oos20260301_pbo18`（18/18 grid，938 samples）→ direct rows `pbo_status=measured` → metrics adapter 5/5 PASS，但 matrix 前置 fail：all regimes `DSR=0.0`、PBO `0.54583333` 不小於 0.5；chop 只是 n=142 / net 35.85bps / PSR 0.9675，仍被 DSR/PBO 擋住。oi_delta true run `aeg_s3_oi_delta_v125_20260611T200033Z_oos20260301_pbo18`（18/18 grid，294 samples，mean net 2.42bps）→ direct rows `pbo_status=measured` → metrics adapter 3 PASS / 2 FAIL，但 matrix 前置 fail 更明確：all regimes `DSR=0.0`、PBO `0.9125`，range PSR 0.941<0.95，bear/high-vol net 為負，bull/high-vol 樣本/freshness/OOS 不足。Formal robustness matrix 未借用 `multiday_trend_reference` smoke breadth（避免 candidate_id lineage 錯配）；若要正式 matrix artifact，需 candidate-specific breadth/execution-realism path，但目前 DSR/PBO/PSR 已足夠阻止 funding_revive 與 oi_delta 晉升。PM reports：`docs/CCAgentWorkSpace/PM/workspace/reports/2026-06-11--aeg_s3_true_panel_first_candidate_rows.md`、`docs/CCAgentWorkSpace/PM/workspace/reports/2026-06-12--aeg_s3_funding_revive_pbo_grid.md`、`docs/CCAgentWorkSpace/PM/workspace/reports/2026-06-12--aeg_s3_oi_delta_pbo_grid.md`。**下一步**：等/導入 operator-timed Gate-B 真 transition artifact 補 listing-fade；若 Gate-B 還未到，先做 candidate-specific breadth/execution-realism wiring 讓 formal matrix artifact 不再依賴 smoke breadth；未經 E2/MIT/QC 獨立審前不得當 promotion proof。 |
