...
| `P1-DATA-1` | 3 | WARN cluster: `[40]`, `[45]`; `[14]` contextualized, `[37]` recovered-history semantics source-fixed | Exit-feature accumulation still warns when samples stall, but now distinguishes risk/cost gate suppression from writer-health evidence. Realized edge and pricing freshness remain quality signals. |
