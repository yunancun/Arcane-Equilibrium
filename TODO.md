...
| `P2-TAB-LIVE-LOC` | ⛔ **DEFERRED 2026-05-19** → 新 ticket `P2-TAB-LIVE-JS-EXTRACT` E1a memo：tab-live.html 2171 LOC 超 cap 但拆 HTML markup 需引 Jinja2 / partial-loading helper（架構變更超 hygiene 範圍）。建議先抽底部內聯 `<script>` 至 `tab-live.js`（pattern 同 app-paper.js / risk-tab.js / governance-tab.js / canary-tab.js），預估 HTML -800~-1000 LOC → ~1100-1300 重回 cap。 |
