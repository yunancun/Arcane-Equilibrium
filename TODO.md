...
- W-A/W-B/W-E/W-G backend foundation DONE。W-C MAG-082 Stage 2 **WINDOW_PASS 2026-05-11**（post Caveat 1+2 fix `ccf7a4bc` + empirical SQL missed_n=0 entry / 14.7 state_changes/min；sign-off `docs/governance_dev/2026-05-11--w_c_window_pass_signoff.md`）。W-D MAG-083 audit READY for dispatch。
...
**Dispatch Order** — ✅ MAG-082 runtime lineage PASS 2026-05-11；W-D MAG-083/084 READY；但 proposal relay / Telegram/WebChat / 第二 GUI / Stage 3/4 / true live autonomy 仍受 W-AUDIT-3..7 + LG-2/3/4 + edge net-positive + ops gates 限制，不因 W-C PASS 自動解除。
...
| 4 | `W-D` MAG-083 / MAG-084 | alpha-neutral | QA + PA + QC 三角 → operator | 🔵 **READY 2026-05-11** | W-C unblocked；MAG-083 audit reviewer brief 4 章節（Caveat 1+2 fix wiring / real-fill propagation transition / Caveat 3 by-design lease bypass / cross-language byte-equal）。 |
...
| `P0-AGENT-3` | 🔵 READY | MAG-083 final release audit | W-C unblocked；QA + PA + QC 三角 dispatch；reviewer brief 4 章節 per sign-off §4。 |
| `P0-AGENT-4` | ⏳ BLOCKED | MAG-084 operator sign-off | 等 MAG-083 三角 PASS。 |
