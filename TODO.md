...
```
3475 passed / 21 failed / 17 errors（LOW/P3 全掃後；+36 新測試；pre-existing failures 不影響本工作）
...
### [x] APR01-E5-LEGACY: main_legacy.py 5113 行單文件重構
- **來源**: E5 #15
- **修復**: Wave A-E 重構，5265→407 行（-92%），拆出 11 個模塊
- ✅ 完成：commits 039b5fd → 32adf48（2026-04-01）
