...
**日期**：2026-05-31
**HEAD**：Mac/origin/Linux source = `main@aa92be52b31b3955fb38ae37f7fb0e98be6cd3e3`；Linux runtime **DEPLOYED** via atomic rebuild/restart，engine PID `968350`，binary SHA `30adb40cc4dfbc9649c7b338a785932b30bd6c50cc5cfe28fd700a32e5a939a1`。**V115 applied**；V104 runtime state now `_sqlx_migrations version104=true` + `learning.supervised_live_audit` exists；AUTO_MIGRATE remains disabled at boot (normal posture).
...
| **v5.8 §4 業務 Sprint 2（Alpha Tournament）** | Alpha Tournament + M4 stage 1 + M10 Tier A + M8 read-only — per v5.8 §4 + SSOT `docs/execution_plan/2026-05-26--alpha_tournament_ssot_spec.md` | 🟡 **SSOT SPEC-FINAL / PARTIAL IMPL STARTED**（M4 Stage 1 runner source branch WIP；未 merge/deploy） |
...
**三端 sync**：2026-05-31 v87 current = Mac / origin/main / Linux trade-core all `main@aa92be52b31b3955fb38ae37f7fb0e98be6cd3e3`；Linux runtime rebuilt from that tree, engine PID `968350`, binary SHA `30adb40cc4dfbc9649c7b338a785932b30bd6c50cc5cfe28fd700a32e5a939a1`；API healthz 200；watchdog engine/demo/live fresh，paper archived/stale by design.
...
| **M4** | Self-supervised hypothesis discovery | DESIGN-DONE / **V100 base table ✅ land 663 SQL+581 spec** / Stage 1 runner **SOURCE WIP on branch**（non-dry-run compute + gated writeback；no deploy） | 1500-2000/600/700 | 170-240（V100 ✅ done；Stage1 runner narrow slice WIP） | γ ✅ / **Sprint 6+ Pattern Miner active per ADR-0045** / Sprint 8 stage 2 / Y2 Q2-Q3 full loop |
