...
- **Current Wave**：**Sprint 2 Wave 1+2 ✅ DONE-VERDICT-PASS WITH 5 CARRY-OVER (2026-05-22 PM-signed)** — Sprint 2 M3 metric emitter 6 Track (engine_runtime / pipeline_throughput / database_pool / api_latency / strategy_quality / risk_envelope) + Cross-Wave OBSERVE-4 全 closure；E4 cargo 3894/0 + pytest 6042/28 + 51/51 Sprint 2 integration + spike 3/3 + nm 0 hit；QA AC-1a/2/3/4/5/6 PASS + AC-1b PARTIAL DEFER by-design + AC-7 OPEN Sprint 5；TW Overall Acceptance Report 700 LOC / 14,000 字；PM Phase 3e sign-off DONE；**Sprint 5 cascade dispatch readiness gate OPEN**；5 carry-over routing (§4.1 Sprint 4+ 4 items / §4.2 Sprint 5+ 4 items / §4.3 Doc+lint 3 items)；**Next: Sprint 4+ first Live carry-over 派發**（AC-1b real PG empirical + main.rs scheduler 接線 + PA-DRIFT-4 bybit instrumentation + PA-DRIFT-5 RiskEnvelopeSourceProbe wire-up）OR Sprint 5 cascade IMPL dispatch；commit c21367ca PM sign-off
