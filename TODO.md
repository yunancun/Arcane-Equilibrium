...
| ID | Task | Status |
|---|---|---|
| `P2-N2-1` | btc_lead_lag.rs 4-split (producer/ingest/snapshot/db_writer) | ⏳ PENDING |
| `P2-N2-2` | w2_paper_edge_report.py 4-split (metrics/render/smoke/report) | 🔄 IN FLIGHT (Codex) |
