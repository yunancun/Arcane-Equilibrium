...
```
Python: 3334 passed / Rust: 790 passed (core 385+8+19 + engine 305+29+36+8)
Total:  4124 tests
注：RC-10 session 後基準線更新（2026-04-05）
注：1 engine test pre-existing fail (feature_collector DonchianResult width)
```
