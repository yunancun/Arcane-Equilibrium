...
| `AEG-S3-CANDIDATE-DIRECT-ROWS` | 1 | 🟡 PM-local infra DONE / formal matrices fail-closed / 等 Gate-B | 2026-06-11/12 已完成 artifact-only AEG-S3 direct rows infra、V125/V127 true panel export、funding_revive + oi_delta evidence/PBO/direct rows/metrics；Mac focused regression 最新 = **91 passed** + compileall OK + static forbidden-route search無命中。funding_revive PBO run `aeg_s3_funding_revive_v125_20260611T200033Z_oos20260301_pbo18`（18/18 grid，938 samples）→ metrics 5/5 PASS 但 all regimes `DSR=0.0`、PBO `0.54583333`，formal matrix `aeg_s3_funding_revive_robustness_v125_20260611T200033Z_oos20260301_pbo18` final labels 4 insufficient / 2 kill。oi_delta PBO run `aeg_s3_oi_delta_v125_20260611T200033Z_oos20260301_pbo18`（18/18 grid，294 samples）→ metrics 3 PASS / 2 FAIL，all regimes `DSR=0.0`、PBO `0.9125`，formal matrix `aeg_s3_oi_delta_robustness_v125_20260611T200033Z_oos20260301_pbo18` final labels 3 insufficient / 2 kill / 1 stale-data. 2026-06-12 新增 `research/aeg_s3_matrix_inputs/`（`25ec85dd`）解掉 smoke breadth lineage 問題：用 `l2_owed_v127_pop_20260610` full V127 regime artifact + candidate-specific fail-closed breadth/execution inputs 產 formal matrix；coverage FAIL、survivorship unverified、execution unverified 均為刻意 fail-closed，非 promotion blocker 誤報。PM reports：`2026-06-11--aeg_s3_true_panel_first_candidate_rows.md`、`2026-06-12--aeg_s3_funding_revive_pbo_grid.md`、`2026-06-12--aeg_s3_oi_delta_pbo_grid.md`、`2026-06-12--aeg_s3_candidate_specific_matrix_inputs.md`。**下一步**：等/導入 operator-timed Gate-B 真 transition artifact 補 listing-fade；若 Gate-B 還未到，下一個工程項是「真」candidate-specific breadth evaluation against FND-2 PIT tiers + empirical execution realism，不是再做 PSR-only sweep；未經 E2/MIT/QC 獨立審前不得當 promotion proof。 |
