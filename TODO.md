...
| **OPS-2 Phase-2 cutover deploy** | 鏈全綠 merge-ready 2026-06-10（PM sign-off §4 checklist） | ①C-C 外部 alert 3 字串+親簽 ②merge `fix/ops2-phase2-cutover`(4 commits) ③`--rebuild` deploy+Linux full regression(E4 owed) ④C-B 手動 `/auth/renew` 留證 ⑤§13.6 D+15-44 起算+首次 rotation 2026-09-08。 |
