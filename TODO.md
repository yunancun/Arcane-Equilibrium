...
| `AEG-S3-CANDIDATE-DIRECT-ROWS` | 1 | 🟡 PM-local infra DONE / funding_revive PBO DONE / promotion thresholds FAIL | 2026-06-11 已新增 artifact-only `research/aeg_s3_candidate_rows/`、`research/aeg_s3_panel_export/`、`research/aeg_s3_listing_fade/`、`research/aeg_s3_oi_delta/`、`research/aeg_s3_funding_revive/`；Linux read-only 真跑完成：export `aeg_s3_v125_panel_20260611T200033Z`（V125 run `18b3c2f8…` + V127 labels；OI panel 5,920 rows / funding panel 19,536 rows，date span 2025-08-10→2026-06-01；更早歷史因缺 V127 regime fail-closed）。2026-06-12 funding_revive PBO grid support 已三端 code sync（`03b308c7`）；Mac focused regression = **82 passed** + compileall OK + static forbidden-route search無命中。Linux artifact-only true run：`aeg_s3_funding_revive_v125_20260611T200033Z_oos20260301_pbo18`（18/18 PBO grid cells included，938 samples，rejects `overlap_spacing=59` / `missing_forward_return_or_future_price=1`）→ direct rows `aeg_s3_funding_revive_direct_rows_v125_20260611T200033Z_oos20260301_pbo18` `pbo_status=measured` → candidate metrics `aeg_s3_funding_revive_candidate_metrics_v125_20260611T200033Z_oos20260301_pbo18` adapter 5/5 PASS。**但非 promotion proof**：matrix 門檻前置檢查已 fail，全 regimes `DSR=0.0`，PBO `0.54583333` 不小於 0.5；chop 仍只是 n=142 / net 35.85bps / PSR 0.9675，但 DSR/PBO 擋住；bull/high-vol net 為負。Formal robustness matrix 未借用 `multiday_trend_reference` smoke breadth（避免 candidate_id lineage 錯配）；若要正式 matrix artifact，需 funding-specific breadth/execution-realism path，但目前 DSR/PBO 已足夠阻止 funding_revive 晉升。PM reports：`docs/CCAgentWorkSpace/PM/workspace/reports/2026-06-11--aeg_s3_true_panel_first_candidate_rows.md`、`docs/CCAgentWorkSpace/PM/workspace/reports/2026-06-12--aeg_s3_funding_revive_pbo_grid.md`。**下一步**：做 `oi_delta` candidate-grid PBO；同時等/導入 operator-timed Gate-B 真 transition artifact 補 listing-fade；未經 E2/MIT/QC 獨立審前不得當 promotion proof。 |
