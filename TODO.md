...
| 5 | `W-AUDIT-8b` A4-A Funding Skew Directional | alpha-bearing | PA spec → Stage 0R query/report + QC + MIT + BB review | 🔵 **STAGE 0R PACKET ROUND 1 SMOKE DONE 2026-05-16**；waiting panel ≥ 7d + MIT decide K_prior | Spec v0.2 done；PA Wave 4-A Run Plan commit `0d6b7430`；E1 round 1 smoke commit `d5fe19e1` STRUCTURAL PASS (alpha-deficient expected)；7 gaps identified；round 2 預計 2026-05-18~19 (panel 從 5.09d 累到 ≥ 7d 後)；Gap B `K_prior` semantic 待 MIT decision (3 選一：0/filtered/registry)；strategy IMPL and demo spend remain blocked until replay packet is green. |
