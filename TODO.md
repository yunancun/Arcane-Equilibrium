...
| `AEG-S3-CANDIDATE-DIRECT-ROWS` | 1 | 🟡 PM-local infra DONE / 真 panels+rows 已產 / metrics 全 FAIL | 2026-06-11 已新增 artifact-only `research/aeg_s3_candidate_rows/`、`research/aeg_s3_panel_export/`、`research/aeg_s3_listing_fade/`、`research/aeg_s3_oi_delta/`、`research/aeg_s3_funding_revive/`；Mac focused regression = **81 passed** + compileall OK，static forbidden-route search 新模組無命中。2026-06-11 Linux read-only 真跑完成：export `aeg_s3_v125_panel_20260611T200033Z`（V125 run `18b3c2f8…` + V127 labels；OI panel 5,920 rows / funding panel 19,536 rows，date span 2025-08-10→2026-06-01；更早歷史因缺 V127 regime fail-closed）；producer OOS split `2026-03-01`：`oi_delta` evidence 294 samples、mean net **2.42bps**，candidate metrics 5/5 FAIL（主要 `missing_pbo`；bull/high-vol 另 n<30）；`funding_revive` evidence 938 samples、mean net **22.64bps**，candidate metrics 5/5 FAIL（全部 `missing_pbo`，DSR=0.0；chop row n=142 / net 35.85bps / PSR 0.9675 但仍非 promotion proof）。PM report `docs/CCAgentWorkSpace/PM/workspace/reports/2026-06-11--aeg_s3_true_panel_first_candidate_rows.md`。**下一步**：先做 `funding_revive` candidate-grid PBO（優先 chop cell）+ DSR/robustness matrix，再做 `oi_delta` PBO；同時等/導入 operator-timed Gate-B 真 transition artifact 補 listing-fade；未經 E2/MIT/QC 獨立審前不得當 promotion proof。 |
