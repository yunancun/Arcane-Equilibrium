...
**日期**：2026-05-29
**HEAD**：cold-audit source checkpoints `b93d3210` + `11b9531f` on Mac；TODO/report doc sync in progress；engine binary 未載入這兩個 checkpoint，Linux deploy/rebuild pending。
