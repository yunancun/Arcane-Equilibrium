...
| 11 | `W-AUDIT-4` ML 基座 + dead schema (mount W-F-1) | E1×6 並行 + MIT + E2 + E4 | ACTIVE 2026-05-09 (~30h, 3 sessions, after W-AUDIT-1) | V076 Guard A retrofit source/test added for V062/V063/V065; not DB-applied. Remaining: V068-V075 migration set, F-29 engine_mode CHECK, F-08 ML cron, F-09 FUP-2 deploy. Source work may proceed; DB apply/deploy remains separate authorization. |
...
| `P1-AUDIT-ML-4` | 3 | W-AUDIT-4 ML 基座 + dead schema (mounts W-F-1) | ACTIVE: V076 Guard A retrofit source/test added for V062 scanner decay, V063 market_tickers.funding_rate, and V065 openclaw ledger contracts; not DB-applied. Remaining: V068-V071 drop dead schema (4 條, MIT+E1-b 4h) + V072 feature_baselines writer + helper script (MIT+E1-c 4h) + V073 edge_estimate_snapshots cycle hourly cron (E1-c 3h) + V074 decision_outcomes daily backfill (E1-d 3h) + V075/V075b retention + compression policies 9 表 (E1-a+MIT 5h) + F-29 trading.fills.engine_mode='demo_archive_20260418' 6,616 row CHECK (E1-f 2h) + F-08 5 ML 腳本 cron (thompson/optuna/cpcv/dl3/weekly_report, E1+ops 3h) + F-09 sibling FUP-2 commit `34211ab4` E4 regression + merge + deploy (E4+ops 4h, passive wait). Heavy parallel; 3 sessions; depends on W-AUDIT-1. |
