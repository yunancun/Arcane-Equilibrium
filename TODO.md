...
**日期**：2026-05-29
**HEAD**：Mac = origin = Linux `main` = `faaa72e2`（三端同步）；Linux engine binary **已 rebuild/deploy**（新 binary 含全部 cold-audit Wave1-4+P3 code，PID 27582）。本輪 v84 TODO 更新待 commit + push + Linux pull。
