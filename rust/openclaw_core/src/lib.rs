...
// Audit emit primitives extracted to keep governance_core.rs within the
// inclusive 2000 LOC ceiling and decouple E1/E4 retrofit collisions on the same file.
// AMD-2026-05-02-01 Track H E-4 retrofit（E2 round 1 verdict HIGH-1 fix）：
// 將 audit emit 基礎元件抽出，使 governance_core.rs 維持在 inclusive 2000 LOC
// 上限（≤ 2000）內，並解耦 E1/E4 retrofit 對同檔的撞車。
