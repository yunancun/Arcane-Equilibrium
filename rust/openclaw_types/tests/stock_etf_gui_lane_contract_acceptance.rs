...
fn accepted_fixture_is_display_only_get_only_and_crypto_default() {
    ...
    assert_eq!(
        contract.policy_status_endpoint,
        STOCK_ETF_GUI_POLICY_STATUS_ENDPOINT
    );
    assert_eq!(
        contract.authorization_status_endpoint,
        STOCK_ETF_GUI_AUTHORIZATION_STATUS_ENDPOINT
    );
    assert_eq!(
        contract.account_status_endpoint,
    ...
    assert_eq!(
        contract.shadow_status_endpoint,
    ...
    assert_eq!(
        contract.release_packet_status_endpoint,
    ...
    assert!(contract.release_packet_status_endpoint_get_only);
...
fn gui_lane_contract_requires_all_stock_etf_readonly_get_endpoints() {
    ...
    contract.policy_status_endpoint_get_only = false;
    contract.authorization_status_endpoint = "/api/v1/stock-etf/authz".to_string();
    contract.authorization_status_endpoint_get_only = false;
    contract.account_status_endpoint = "/api/v1/stock-etf/account".to_string();
    contract.account_status_endpoint_get_only = false;
    ...
    contract.shadow_status_endpoint = "/api/v1/stock-etf/shadow".to_string();
    ...
    contract.release_packet_status_endpoint = "/api/v1/stock-etf/release".to_string();
    contract.release_packet_status_endpoint_get_only = false;
...
fn blocked_template_is_parseable_and_secret_free() {
    ...
    assert_eq!(
        parsed.release_packet_status_endpoint,
        STOCK_ETF_GUI_RELEASE_PACKET_STATUS_ENDPOINT
    );
    assert_eq!(
