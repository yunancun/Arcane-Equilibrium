...
pub const STOCK_ETF_GET_DATA_FOUNDATION_STATUS: IpcMethodSpec = IpcMethodSpec {
    name: "stock_etf.get_data_foundation_status",
    readonly: true,
    slot: IpcSlotRequirement::None,
};

pub const STOCK_ETF_GET_POLICY_STATUS: IpcMethodSpec = IpcMethodSpec {
    name: "stock_etf.get_policy_status",
    readonly: true,
    slot: IpcSlotRequirement::None,
};
...
pub const STOCK_ETF_GET_PAPER_STATUS: IpcMethodSpec = IpcMethodSpec {
    name: "stock_etf.get_paper_status",
    readonly: true,
    slot: IpcSlotRequirement::None,
};

pub const STOCK_ETF_GET_RECONCILIATION_STATUS: IpcMethodSpec = IpcMethodSpec {
    name: "stock_etf.get_reconciliation_status",
    readonly: true,
    slot: IpcSlotRequirement::None,
};

pub const STOCK_ETF_GET_SCORECARD_STATUS: IpcMethodSpec = IpcMethodSpec {
    name: "stock_etf.get_scorecard_status",
    readonly: true,
    slot: IpcSlotRequirement::None,
};

pub const STOCK_ETF_GET_LAUNCH_STATUS: IpcMethodSpec = IpcMethodSpec {
    name: "stock_etf.get_launch_status",
    readonly: true,
    slot: IpcSlotRequirement::None,
};

pub const STOCK_ETF_GET_RELEASE_PACKET_STATUS: IpcMethodSpec = IpcMethodSpec {
    name: "stock_etf.get_release_packet_status",
    readonly: true,
    slot: IpcSlotRequirement::None,
};
