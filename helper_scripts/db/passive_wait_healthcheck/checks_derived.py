...
These three are derivative / cross-cutting checks that don't fit the
...
scale ratios; [18] surfaces TOML-disabled strategies for §三 drift defense.
...
CLAUDE.md §三 drift。SQL / exit code / 輸出格式與拆分前 byte-identical。
"""
