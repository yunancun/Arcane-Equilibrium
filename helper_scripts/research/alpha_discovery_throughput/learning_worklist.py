...
_EVIDENCE_KEYS = (
    ...
    "mm_current_fee_confirmation_candidate_observed_windows",
    ...
    "candidate_artifact_dependency_status",
    "candidate_artifact_dependency_reason",
    ...
    "false_negative_operator_review_approval_source",
    ...
    "profitability_path_count",
    "profitability_cost_gate_crossing_candidate_count",
    "profitability_top_path_id",
...
def _completion_evidence_required(task_type: str) -> list[str]:
    ...
    if task_type == "operator_probe_review":
        return [
            ...
            "false_negative_operator_review records preflight decision without runtime authority when present",
