...
def test_mm_fee_polymarket_and_gate_b_paths_are_separated() -> None:
    scorecard = build_profitability_path_scorecard(
        ...
        fillsim_history={
            ...
            "low_friction_near_miss_motif_stability": {
                "status": "LOW_FRICTION_NEAR_MISS_MOTIF_REPEATS_ACROSS_WINDOWS",
                "reason": "repeated_low_friction_near_miss_motif_across_windows",
                "repeated_motif_count": 1,
                "best_repeated_near_miss_motif": {
                    "motif_key": "low_friction_motif|spread_combo|thin_queue|spread_delta",
                    "windows": 3,
    ...
    assert mm_evidence["history_low_friction_near_miss_motif_stability_status"] == (
        "LOW_FRICTION_NEAR_MISS_MOTIF_REPEATS_ACROSS_WINDOWS"
    )
    assert mm_evidence["history_low_friction_near_miss_repeated_motif_count"] == 1
